import { La as e, Sn as t, nt as n } from "./index-Dl4ETd_L-D2oMd1k2.js";
import { n as r, t as i } from "./index-DINISCAW-DhRXH5fW.js";
import { t as a } from "./index-Df-1Z3LJ-BbKzDPIK.js";
//#region ../react/build/index-Dk9oWC2N.js
function o(e, t) {
	return s(e, {}) || {
		type: "root",
		children: []
...
function p(e, t) {
	let n = e.namespaceURI, o = n === a.svg ? r : i, s = n === a.html ? e.tagName.toLowerCase() : e.tagName, c = n === a.html && s === "template" ? e.content : e, l = e.getAttributeNames(), u = {}, d = -1;
	for (; ++d < l.length;) u[l[d]] = e.getAttribute(l[d]) || "";
	return o(s, u, m(c, t));
}
function m(e, t) {
...
var _ = function(e, n, r) {
	...
	} else if (n = e.children.indexOf(n), n < 0) throw Error("Expected child node or index");
	for (; ++n < e.children.length;) if (i(e.children[n], n, e)) return e.children[n];
}, v = function(e) {
	if (e == null) return S;
	if (typeof e == "string") return b(e);
	if (typeof e == "object") return y(e);
	if (typeof e == "function") return x(e);
...
var ee = /\n/g, te = /[\t ]+/g, w = v("br"), ne = v(he), re = v("p"), ie = v("tr"), ae = v([
	"datalist",
	"head",
	"noembed",
	"noframes",
	...
	me,
	ge
]), oe = v(/* @__PURE__ */ "address.article.aside.blockquote.body.caption.center.dd.dialog.dir.dl.dt.div.figure.figcaption.footer.form,.h1.h2.h3.h4.h5.h6.header.hgroup.hr.html.legend.li.listing.main.menu.nav.ol.p.plaintext.pre.section.ul.xmp".split("."));
function se(e, t) {
	let n = t || {}, r = "children" in e ? e.children : [], i = oe(e), a = pe(e, { whitespace: n.whitespace || "normal" }), o = [];
	(e.type === "text" || e.type === "comment") && o.push(...ue(e, {
		breakBefore: !0,
		breakAfter: !0
	}));
	let s = -1;
	for (; ++s < r.length;) o.push(...ce(r[s], e, {
		whitespace: a,
		breakBefore: s ? void 0 : i,
		breakAfter: s < r.length - 1 ? w(r[s + 1]) : i
	}));
	let c = [], l;
	for (s = -1; ++s < o.length;) {
		let e = o[s];
...
function ce(e, t, n) {
	return e.type === "element" ? le(e, t, n) : e.type === "text" ? n.whitespace === "normal" ? ue(e, n) : de(e) : [];
}
function le(e, t, n) {
	let r = pe(e, n), i = e.children || [], a = -1, o = [];
	if (ae(e)) return o;
	let s, c;
	for (w(e) || ie(e) && _(t, e, ie) ? c = "\n" : re(e) ? (s = 2, c = 2) : oe(e) && (s = 1, c = 1); ++a < i.length;) o = o.concat(ce(i[a], e, {
		whitespace: r,
		breakBefore: a ? void 0 : s,
		breakAfter: a < i.length - 1 ? w(i[a + 1]) : c
	}));
	return ne(e) && _(t, e, ne) && o.push("	"), s && o.unshift(s), c && o.push(c), o;
}
function ue(e, t) {
	let n = String(e.value), r = [], i = [], a = 0;
	for (; a <= n.length;) {
		ee.lastIndex = a;
		let e = ee.exec(n), i = e && "index" in e ? e.index : n.length;
		r.push(fe(n.slice(a, i).replace(/[\u061C\u200E\u200F\u202A-\u202E\u2066-\u2069]/g, ""), a === 0 ? t.breakBefore : !0, i === n.length ? t.breakAfter : !0)), a = i + 1;
	}
	let o = -1, s;
...
var _e = class e {
	...
	range(t, n) {
		return new e(n, _e.range(this, t));
	}
}, T = class e {
	constructor(t, n) {
		...
		var d = Error(r);
		return d.name = "ParseError", d.__proto__ = e.prototype, d.position = i, i != null && a != null && (d.length = a - i), d.rawMessage = t, d;
	}
};
T.prototype.__proto__ = Error.prototype;
var ye = function(e, t) {
	return e === void 0 ? t : e;
}, be = /([A-Z])/g, xe = function(e) {
...
function we(e) {
	return String(e).replace(Ce, (e) => Se[e]);
}
var Te = function e(t) {
...
var Ae = class {
	constructor(e) {
		for (var t in this.displayMode = void 0, this.output = void 0, this.leqno = void 0, this.fleqn = void 0, this.throwOnError = void 0, this.errorColor = void 0, this.macros = void 0, this.minRuleThickness = void 0, this.colorIsTextColor = void 0, this.strict = void 0, this.trust = void 0, this.maxSize = void 0, this.maxExpand = void 0, this.globalGroup = void 0, e ||= {}, Oe) if (Oe.hasOwnProperty(t)) {
			var n = Oe[t];
			this[t] = e[t] === void 0 ? ke(n) : n.processor ? n.processor(e[t]) : e[t];
		}
	}
	reportNonstrict(e, t, n) {
		var r = this.strict;
		if (typeof r == "function" && (r = r(e, t, n)), !(!r || r === "ignore")) {
			if (r === !0 || r === "error") throw new T("LaTeX-incompatible input and strict mode is set to 'error': " + (t + " [" + e + "]"), n);
	...
	sup() {
		return Be[Ve[this.id]];
	}
	sub() {
		return Be[He[this.id]];
	}
	fracNum() {
		return Be[Ue[this.id]];
	}
	fracDen() {
		return Be[We[this.id]];
	}
	cramp() {
		return Be[Ge[this.id]];
	}
	text() {
		return Be[Ke[this.id]];
	}
	isTight() {
		return this.size >= 2;
	}
}, Me = 0, Ne = 1, Pe = 2, Fe = 3, Ie = 4, Le = 5, Re = 6, ze = 7, Be = [
	new je(Me, 0, !1),
	new je(Ne, 0, !0),
	new je(Pe, 1, !1),
	new je(Fe, 1, !0),
...
function Je(e) {
	for (var t = 0; t < qe.length; t++) for (var n = qe[t], r = 0; r < n.blocks.length; r++) {
		var i = n.blocks[r];
...
var Ye = [];
qe.forEach((e) => e.blocks.forEach((e) => Ye.push(...e)));
function Xe(e) {
	for (var t = 0; t < Ye.length; t += 2) if (e >= Ye[t] && e <= Ye[t + 1]) return !0;
	return !1;
}
var Ze = 80, Qe = function(e, t) {
...
function mt(e, t, n) {
	if (!ut[t]) throw Error("Font metrics not found for font: " + t + ".");
	var r = e.charCodeAt(0), i = ut[t][r];
	if (!i && e[0] in ft && (r = ft[e[0]].charCodeAt(0), i = ut[t][r]), !i && n === "text" && Xe(r) && (i = ut[t][77]), i) return {
		depth: i[0],
		height: i[1],
		italic: i[2],
		skew: i[3],
...
function gt(e) {
	var t;
	if (t = e >= 5 ? 0 : e >= 3 ? 1 : 2, !ht[t]) {
		var n = ht[t] = { cssEmPerMu: dt.quad[t] / 18 };
...
var _t = [
	...
	return t.size < 2 ? e : _t[e - 1][t.size - 1];
}, bt = class e {
	constructor(t) {
		this.style = void 0, this.color = void 0, this.size = void 0, this.textSize = void 0, this.phantom = void 0, this.font = void 0, this.fontFamily = void 0, this.fontWeight = void 0, this.fontShape = void 0, this.sizeMultiplier = void 0, this.maxSize = void 0, this.minRuleThickness = void 0, this._fontMetrics = void 0, this.style = t.style, this.color = t.color, this.size = t.size || e.BASESIZE, this.textSize = t.textSize || this.size, this.phantom = !!t.phantom, this.font = t.font || "", this.fontFamily = t.fontFamily || "", this.fontWeight = t.fontWeight || "", this.fontShape = t.fontShape || "", this.sizeMultiplier = vt[this.size - 1], this.maxSize = t.maxSize, this.minRuleThickness = t.minRuleThickness, this._fontMetrics = void 0;
	}
	extend(t) {
		var n = {
			style: this.style,
	...
	fontMetrics() {
		return this._fontMetrics ||= gt(this.size), this._fontMetrics;
	}
	getColor() {
...
var xt = {
	...
	return typeof e != "string" && (e = e.unit), e in xt || e in St || e === "ex";
}, O = function(e, t) {
	var n;
	if (e.unit in xt) n = xt[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
	else if (e.unit === "mu") n = t.fontMetrics().cssEmPerMu;
	else {
		var r;
		if (r = t.style.isTight() ? t.havingStyle(t.style.text()) : t, e.unit === "ex") n = r.fontMetrics().xHeight;
	...
	for (var n in t.className = wt(this.classes), this.style) this.style.hasOwnProperty(n) && (t.style[n] = this.style[n]);
	...
	return t;
}, Dt = /[\s"'>/=\x00-\x1f]/, Ot = function(e) {
	var t = "<" + e;
	this.classes.length && (t += " class=\"" + E.escape(wt(this.classes)) + "\"");
	var n = "";
	for (var r in this.style) this.style.hasOwnProperty(r) && (n += E.hyphenate(r) + ":" + this.style[r] + ";");
	for (var i in n && (t += " style=\"" + E.escape(n) + "\""), this.attributes) if (this.attributes.hasOwnProperty(i)) {
		if (Dt.test(i)) throw new T("Invalid attribute name '" + i + "'");
		t += " " + i + "=\"" + E.escape(this.attributes[i]) + "\"";
	}
	t += ">";
	...
	constructor(e, t, n, r) {
		this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.width = void 0, this.maxFontSize = void 0, this.style = void 0, Tt.call(this, e, n, r), this.children = t || [];
	}
	setAttribute(e, t) {
		this.attributes[e] = t;
	}
	...
	constructor(e, t, n, r) {
		this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.maxFontSize = void 0, this.style = void 0, Tt.call(this, t, r), this.children = n || [], this.setAttribute("href", e);
	}
	setAttribute(e, t) {
		this.attributes[e] = t;
	}
	...
	toMarkup() {
		var e = "<img src=\"" + E.escape(this.src) + "\"" + (" alt=\"" + E.escape(this.alt) + "\""), t = "";
		for (var n in this.style) this.style.hasOwnProperty(n) && (t += E.hyphenate(n) + ":" + this.style[n] + ";");
		return t && (e += " style=\"" + E.escape(t) + "\""), e += "'/>", e;
	}
}, Mt = {
	î: "ı̂",
	ï: "ı̈",
	...
	constructor(e, t, n, r, i, a, o, s) {
		...
		var c = Je(this.text.charCodeAt(0));
		c && this.classes.push(c + "_fallback"), /[îïíì]/.test(this.text) && (this.text = Mt[this.text]);
	}
	hasClass(e) {
		return this.classes.includes(e);
	}
	toNode() {
		...
		for (var n in this.italic > 0 && (t = document.createElement("span"), t.style.marginRight = k(this.italic)), this.classes.length > 0 && (t ||= document.createElement("span"), t.className = wt(this.classes)), this.style) this.style.hasOwnProperty(n) && (t ||= document.createElement("span"), t.style[n] = this.style[n]);
		return t ? (t.appendChild(e), t) : e;
	}
	toMarkup() {
		var e = !1, t = "<span";
		this.classes.length && (e = !0, t += " class=\"", t += E.escape(wt(this.classes)), t += "\"");
		var n = "";
		for (var r in this.italic > 0 && (n += "margin-right:" + this.italic + "em;"), this.style) this.style.hasOwnProperty(r) && (n += E.hyphenate(r) + ":" + this.style[r] + ";");
		n && (e = !0, t += " style=\"" + E.escape(n) + "\"");
		var i = E.escape(this.text);
	...
	toMarkup() {
		...
		for (var t in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, t) && (e += " " + t + "=\"" + E.escape(this.attributes[t]) + "\"");
		e += ">";
	...
	toNode() {
		...
		return this.alternate ? e.setAttribute("d", this.alternate) : e.setAttribute("d", st[this.pathName]), e;
	}
	toMarkup() {
		return this.alternate ? "<path d=\"" + E.escape(this.alternate) + "\"/>" : "<path d=\"" + E.escape(st[this.pathName]) + "\"/>";
	}
}, It = class {
	constructor(e) {
...
for (var qt = "0123456789/@.\"", Jt = 0; Jt < qt.length; Jt++) {
	var Yt = qt.charAt(Jt);
	j(M, P, V, Yt, Yt);
}
for (var Xt = "0123456789!@*()-=+\";:?/.,", Zt = 0; Zt < Xt.length; Zt++) {
	var Qt = Xt.charAt(Zt);
	j(N, P, V, Qt, Qt);
}
for (var $t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", en = 0; en < $t.length; en++) {
	var tn = $t.charAt(en);
	j(M, P, R, tn, tn), j(N, P, V, tn, tn);
}
...
for (var H = "", nn = 0; nn < $t.length; nn++) {
	var U = $t.charAt(nn);
	H = String.fromCharCode(55349, 56320 + nn), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56372 + nn), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56424 + nn), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56580 + nn), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56684 + nn), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56736 + nn), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56788 + nn), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56840 + nn), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56944 + nn), j(M, P, R, U, H), j(N, P, V, U, H), nn < 26 && (H = String.fromCharCode(55349, 56632 + nn), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56476 + nn), j(M, P, R, U, H), j(N, P, V, U, H));
}
H = "𝕜", j(M, P, R, "k", H), j(N, P, V, "k", H);
for (var rn = 0; rn < 10; rn++) {
	var an = rn.toString();
	H = String.fromCharCode(55349, 57294 + rn), j(M, P, R, an, H), j(N, P, V, an, H), H = String.fromCharCode(55349, 57314 + rn), j(M, P, R, an, H), j(N, P, V, an, H), H = String.fromCharCode(55349, 57324 + rn), j(M, P, R, an, H), j(N, P, V, an, H), H = String.fromCharCode(55349, 57334 + rn), j(M, P, R, an, H), j(N, P, V, an, H);
}
for (var on = "ÐÞþ", sn = 0; sn < on.length; sn++) {
	var cn = on.charAt(sn);
	j(M, P, R, cn, cn), j(N, P, V, cn, cn);
}
var ln = [
	[
		"mathbf",
	...
	var n = e.charCodeAt(0), r = e.charCodeAt(1), i = (n - 55296) * 1024 + (r - 56320) + 65536, a = t === "math" ? 0 : 1;
	if (119808 <= i && i < 120484) {
		var o = Math.floor((i - 119808) / 26);
		return [ln[o][2], ln[o][a]];
	} else if (120782 <= i && i <= 120831) {
		var s = Math.floor((i - 120782) / 10);
		return [un[s][2], un[s][a]];
	} else {
		if (i === 120485 || i === 120486) return [ln[0][2], ln[0][a]];
		if (120486 < i && i < 120782) return ["", ""];
		throw new T("Unsupported character: " + e);
	}
}, fn = function(e, t, n) {
	return A[n][e] && A[n][e].replace && (e = A[n][e].replace), {
		value: e,
		metrics: mt(e, t, n)
	};
}, pn = function(e, t, n, r, i) {
	var a = fn(e, t, n), o = a.metrics;
	e = a.value;
	var s;
	if (o) {
		var c = o.italic;
		(n === "text" || r && r.font === "mathit") && (c = 0), s = new Nt(e, o.height, o.depth, c, o.skew, o.width, i);
	} else typeof console < "u" && console.warn("No character metrics " + ("for '" + e + "' in style '" + t + "' and mode '" + n + "'")), s = new Nt(e, 0, 0, 0, 0, 0, i);
	if (r) {
	...
	return r === void 0 && (r = []), n.font === "boldsymbol" && fn(e, "Main-Bold", t).metrics ? pn(e, "Main-Bold", t, n, r.concat(["mathbf"])) : e === "\\" || A[t][e].font === "main" ? pn(e, "Main-Regular", t, n, r) : pn(e, "AMS-Regular", t, n, r.concat(["amsrm"]));
}, hn = function(e, t, n, r, i) {
	return i !== "textord" && fn(e, "Math-BoldItalic", t).metrics ? {
	...
	var r = e.mode, i = e.text, a = ["mord"], o = r === "math" || r === "text" && t.font, s = o ? t.font : t.fontFamily, c = "", l = "";
	if (i.charCodeAt(0) === 55349 && ([c, l] = dn(i, r)), c.length > 0) return pn(i, c, r, t, a.concat(l));
	if (s) {
		var u, d;
		if (s === "boldsymbol") {
			var f = hn(i, r, t, a, n);
			u = f.fontName, d = [f.fontClass];
		} else o ? (u = An[s].fontName, d = [s]) : (u = kn(s, t.fontWeight, t.fontShape), d = [
			s,
			t.fontWeight,
			t.fontShape
		]);
		if (fn(i, u, r).metrics) return pn(i, u, r, t, a.concat(d));
		if (Kt.hasOwnProperty(i) && u.slice(0, 10) === "Typewriter") {
			for (var p = [], m = 0; m < i.length; m++) p.push(pn(i[m], u, r, t, a.concat(d)));
			return wn(p);
		}
	}
	if (n === "mathord") return pn(i, "Math-Italic", r, t, a.concat(["mathnormal"]));
	if (n === "textord") {
		var h = A[r][i] && A[r][i].font;
		if (h === "ams") return pn(i, kn("amsrm", t.fontWeight, t.fontShape), r, t, a.concat("amsrm", t.fontWeight, t.fontShape));
		if (h === "main" || !h) return pn(i, kn("textrm", t.fontWeight, t.fontShape), r, t, a.concat(t.fontWeight, t.fontShape));
		var g = kn(h, t.fontWeight, t.fontShape);
		return pn(i, g, r, t, a.concat(g, t.fontWeight, t.fontShape));
	} else throw Error("unexpected type: " + n + " in makeOrd");
}, _n = (e, t) => {
	if (wt(e.classes) !== wt(t.classes) || e.skew !== t.skew || e.maxFontSize !== t.maxFontSize) return !1;
	...
	for (var t = 0; t < e.length - 1; t++) {
		var n = e[t], r = e[t + 1];
		n instanceof Nt && r instanceof Nt && _n(n, r) && (n.text += r.text, n.height = Math.max(n.height, r.height), n.depth = Math.max(n.depth, r.depth), n.italic = r.italic, e.splice(t + 1, 1), t--);
	}
	return e;
}, yn = function(e) {
	...
	var i = new kt(e, t, n, r);
	return yn(i), i;
}, xn = (e, t, n, r) => new kt(e, t, n, r), Sn = function(e, t, n) {
	var r = bn([e], [], t);
	...
	var i = new At(e, t, n, r);
	return yn(i), i;
}, wn = function(e) {
	var t = new lt(e);
	return yn(t), t;
}, Tn = function(e, t) {
	return e instanceof lt ? bn([], [e], t) : e;
}, En = function(e) {
	...
	for (var { children: n, depth: r } = En(e), i = 0, a = 0; a < n.length; a++) {
		var o = n[a];
		if (o.type === "elem") {
			var s = o.elem;
	...
	for (var l = [], u = r, d = r, f = r, p = 0; p < n.length; p++) {
		...
		if (m.type === "kern") f += m.size;
			...
			var h = m.elem, g = m.wrapperClasses || [], _ = m.wrapperStyle || {}, v = bn(g, [c, h], void 0, _);
	...
	if (u < 0) {
		var x = bn(["vlist"], [bn([], [])]);
		x.style.height = k(-u), b = [bn(["vlist-r"], [y, bn(["vlist-s"], [new Nt("​")])]), bn(["vlist-r"], [x])];
	} else b = [bn(["vlist-r"], [y])];
	var S = bn(["vlist-t"], b);
	return b.length === 2 && S.classes.push("vlist-t2"), S.height = d, S.depth = -u, S;
}, On = (e, t) => {
	var n = bn(["mspace"], [], t), r = O(e, t);
	...
	var i;
	return i = t === "textbf" && n === "textit" ? "BoldItalic" : t === "textbf" ? "Bold" : t === "textit" ? "Italic" : "Regular", r + "-" + i;
}, An = {
	mathbf: {
		variant: "bold",
		fontName: "Main-Bold"
	...
	staticSvg: function(e, t) {
		var [n, r, i] = jn[e], a = xn(["overlay"], [new Pt([new Ft(n)], {
			width: k(r),
			height: k(i),
			style: "width:" + k(r),
...
var Bn = function(e) {
	...
	if (e.length === 1) {
		var l = e[0];
		l.type === "sizing" ? c = t.havingSize(l.size) : l.type === "styling" && (c = t.havingStyle(Wn[l.style]));
	}
	var u = Vn([r[0] || "leftmost"], [], t), d = Vn([r[1] || "rightmost"], [], t), f = n === "root";
	return Kn(i, (e, t) => {
		var n = t.classes[0], r = e.classes[0];
		n === "mbin" && Un.includes(r) ? t.classes[0] = "mord" : r === "mbin" && Hn.includes(n) && (e.classes[0] = "mord");
	}, { node: u }, d, f), Kn(i, (e, t) => {
		var n = Yn(t), r = Yn(e), i = n && r ? e.hasClass("mtight") ? Fn[n][r] : Pn[n][r] : null;
	...
	for (var o = 0; o < t.length; o++) {
		...
		l ? r.node = s : a && s.hasClass("newline") && (r.node = Vn(["leftmost"])), r.insertAfter = /* @__PURE__ */ ((e) => (n) => {
			t.splice(e + 1, 0, n), o++;
		})(o);
	}
	i && t.pop();
}, qn = function(e) {
	return e instanceof lt || e instanceof At || e instanceof kt && e.hasClass("enclosing") ? e : null;
}, Jn = function e(t, n) {
	var r = qn(t);
	if (r) {
		var i = r.children;
	...
	return e ? (t && (e = Jn(e, t)), Gn[e.classes[0]] || null) : null;
}, Xn = function(e, t) {
	var n = ["nulldelimiter"].concat(e.baseSizingClasses());
	return Vn(t.concat(n));
}, Y = function(e, t, n) {
	if (!e) return Vn();
	if (Ln[e.type]) {
		var r = Ln[e.type](e, t);
		if (n && t.size !== n.size) {
			r = Vn(t.sizingClasses(n), [r], t);
...
function Qn(e, t) {
	...
	for (var a = [], o = [], s = 0; s < r.length; s++) if (o.push(r[s]), r[s].hasClass("mbin") || r[s].hasClass("mrel") || r[s].hasClass("allowbreak")) {
		...
		c || (a.push(Zn(o, t)), o = []);
	} else r[s].hasClass("newline") && (o.pop(), o.length > 0 && (a.push(Zn(o, t)), o = []), a.push(r[s]));
	o.length > 0 && a.push(Zn(o, t));
	var l;
	n ? (l = Zn(J(n, t, !0)), l.classes = ["tag"], a.push(l)) : i && a.push(i);
	var u = Vn(["katex-html"], a);
...
var er = class {
	...
	toNode() {
		...
		for (var n = 0; n < this.children.length; n++) if (this.children[n] instanceof tr && this.children[n + 1] instanceof tr) {
			for (var r = this.children[n].toText() + this.children[++n].toText(); this.children[n + 1] instanceof tr;) r += this.children[++n].toText();
			e.appendChild(new tr(r).toNode());
		} else e.appendChild(this.children[n].toNode());
		return e;
	}
	toMarkup() {
		var e = "<" + this.type;
		for (var t in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, t) && (e += " " + t + "=\"", e += E.escape(this.attributes[t]), e += "\"");
		this.classes.length > 0 && (e += " class =\"" + E.escape(wt(this.classes)) + "\""), e += ">";
		for (var n = 0; n < this.children.length; n++) e += this.children[n].toMarkup();
	...
	newDocumentFragment: $n
}, nr = function(e, t, n) {
	return A[t][e] && A[t][e].replace && e.charCodeAt(0) !== 55349 && !(Kt.hasOwnProperty(e) && n && (n.fontFamily && n.fontFamily.slice(4, 6) === "tt" || n.font && n.font.slice(4, 6) === "tt")) && (e = A[t][e].replace), new X.TextNode(e);
}, rr = function(e) {
	...
	return mt(i, a, r) ? W.fontMap[n].variant : null;
};
function ar(e) {
	if (!e) return !1;
	if (e.type === "mi" && e.children.length === 1) {
		var t = e.children[0];
		return t instanceof tr && t.text === ".";
	} else if (e.type === "mo" && e.children.length === 1 && e.getAttribute("separator") === "true" && e.getAttribute("lspace") === "0em" && e.getAttribute("rspace") === "0em") {
		var n = e.children[0];
		return n instanceof tr && n.text === ",";
	} else return !1;
}
var or = function(e, t, n) {
	if (e.length === 1) {
		var r = Z(e[0], t);
		return n && r instanceof er && r.type === "mo" && (r.setAttribute("lspace", "0em"), r.setAttribute("rspace", "0em")), [r];
	}
	for (var i = [], a, o = 0; o < e.length; o++) {
		var s = Z(e[o], t);
		if (s instanceof er && a instanceof er) {
			if (s.type === "mtext" && a.type === "mtext" && s.getAttribute("mathvariant") === a.getAttribute("mathvariant")) {
				...
				a.children.push(...s.children);
				continue;
			} else if (ar(s) && a.type === "mn") {
				a.children.push(...s.children);
				continue;
			} else if (s.type === "mn" && ar(a)) s.children = [...a.children, ...s.children], i.pop();
			else if ((s.type === "msup" || s.type === "msub") && s.children.length >= 1 && (a.type === "mn" || ar(a))) {
				var c = s.children[0];
				c instanceof er && c.type === "mn" && (c.children = [...a.children, ...c.children], i.pop());
			} else if (a.type === "mi" && a.children.length === 1) {
				var l = a.children[0];
				if (l instanceof tr && l.text === "̸" && (s.type === "mo" || s.type === "mi" || s.type === "mn")) {
					var u = s.children[0];
					u instanceof tr && u.text.length > 0 && (u.text = u.text.slice(0, 1) + "̸" + u.text.slice(1), i.pop());
				}
			}
		}
		i.push(s), a = s;
	...
	if (Rn[e.type]) return Rn[e.type](e, t);
	throw new T("Got group of unknown type: '" + e.type + "'");
};
function cr(e, t, n, r, i) {
	var a = or(e, n), o = a.length === 1 && a[0] instanceof er && ["mrow", "mtable"].includes(a[0].type) ? a[0] : new X.MathNode("mrow", a), s = new X.MathNode("annotation", [new X.TextNode(t)]);
	s.setAttribute("encoding", "application/x-tex");
	var c = new X.MathNode("semantics", [o, s]), l = new X.MathNode("math", [c]);
	l.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"), r && l.setAttribute("display", "block");
...
var lr = function(e) {
	...
	if (t.displayMode) {
		var n = ["katex-display"];
		t.leqno && n.push("leqno"), t.fleqn && n.push("fleqn"), e = W.makeSpan(n, [e]);
	}
	return e;
}, dr = function(e, t, n) {
	var r = lr(n), i;
	if (n.output === "mathml") return cr(e, t, r, n.displayMode, !0);
	if (n.output === "html") {
		var a = Qn(e, r);
		i = W.makeSpan(["katex"], [a]);
	} else {
		var o = cr(e, t, r, n.displayMode, !1), s = Qn(e, r);
		i = W.makeSpan(["katex"], [o, s]);
	}
	return ur(i, n);
}, fr = function(e, t, n) {
	var r = Qn(e, lr(n));
	return ur(W.makeSpan(["katex"], [r]), n);
}, pr = {
	widehat: "^",
	widecheck: "ˇ",
	widetilde: "~",
	...
	var t = new X.MathNode("mo", [new X.TextNode(pr[e.replace(/^\\/, "")])]);
	...
	encloseSpan: function(e, t, n, r, i) {
		...
		if (/fbox|color|angl/.test(t)) {
			...
			var c = [];
			/^[bx]cancel$/.test(t) && c.push(new It({
				x1: "0",
				y1: "0",
				x2: "100%",
				y2: "100%",
				"stroke-width": "0.046em"
			})), /^x?cancel$/.test(t) && c.push(new It({
				x1: "0",
				y1: "100%",
				x2: "100%",
				y2: "0",
	...
	svgSpan: function(e, t) {
		function n() {
			...
			if ([
				...
				return {
					span: W.makeSvgSpan([], [l], t),
					minWidth: 0,
					height: s
				};
			} else {
				var u = [], d = hr[r], [f, p, m] = d, h = m / 1e3, g = f.length, _, v;
				if (g === 1) {
					var y = d[3];
					_ = ["hide-tail"], v = [y];
...
function yr(e) {
	return e && (e.type === "atom" || Bt.hasOwnProperty(e.type)) ? e : null;
}
var br = (e, t) => {
	var n, r, i;
	e && e.type === "supsub" ? (r = Q(e.base, "accent"), n = r.base, e.base = n, i = Rt(Y(e, t)), e.base = r) : (r = Q(e, "accent"), n = r.base);
	var a = Y(n, t.havingCrampedStyle()), o = r.isShifty && E.isCharacterBox(n), s = 0;
	o && (s = Lt(Y(E.getBaseElem(n), t.havingCrampedStyle())).skew);
	var c = r.label === "\\c", l = c ? a.height + a.depth : Math.min(a.height, t.fontMetrics().xHeight), u;
	if (r.isStretchy) u = _r.svgSpan(r, t), u = W.makeVList({
		...
		var d, f;
		r.label === "\\vec" ? (d = W.staticSvg("vec", t), f = W.svgData.vec[1]) : (d = W.makeOrd({
			mode: r.mode,
			text: r.label
		}, t, "textord"), d = Lt(d), d.italic = 0, f = d.width, c && (l += d.depth)), u = W.makeSpan(["accent-body"], [d]);
		var p = r.label === "\\textcircled";
		p && (u.classes.push("accent-full"), l = a.height);
		var m = s;
		p || (m -= f / 2), u.style.left = k(m), r.label === "\\textcircled" && (u.style.top = ".2em"), u = W.makeVList({
			positionType: "firstBaseline",
			children: [
				{
					type: "elem",
	...
	var h = W.makeSpan(["mord", "accent"], [u], t);
	return i ? (i.children[0] = h, i.height = Math.max(h.height, i.height), i.classes[0] = "mord", i) : h;
}, xr = (e, t) => {
	var n = e.isStretchy ? _r.mathMLnode(e.label) : new X.MathNode("mo", [nr(e.label, e.mode)]), r = new X.MathNode("mover", [Z(e.base, t), n]);
...
K({
	...
	props: { numArgs: 1 },
	handler: (e, t) => {
		var n = Bn(t[0]), r = !Sr.test(e.funcName), i = !r || e.funcName === "\\widehat" || e.funcName === "\\widetilde" || e.funcName === "\\widecheck";
		return {
			type: "accent",
			mode: e.parser.mode,
			label: e.funcName,
	...
	htmlBuilder: (e, t) => {
		var n = Y(e.base, t), r = _r.svgSpan(e, t), i = e.label === "\\utilde" ? .12 : 0, a = W.makeVList({
			positionType: "top",
	...
	mathmlBuilder: (e, t) => {
		var n = _r.mathMLnode(e.label), r = new X.MathNode("munder", [Z(e.base, t), n]);
...
K({
	...
	htmlBuilder(e, t) {
		var n = t.style, r = t.havingStyle(n.sup()), i = W.wrapFragment(Y(e.body, r, t), t), a = e.label.slice(0, 2) === "\\x" ? "x" : "cd";
		i.classes.push(a + "-arrow-pad");
		var o;
		e.below && (r = t.havingStyle(n.sub()), o = W.wrapFragment(Y(e.below, r, t), t), o.classes.push(a + "-arrow-pad"));
		var s = _r.svgSpan(e, t), c = -t.fontMetrics().axisHeight + .5 * s.height, l = -t.fontMetrics().axisHeight - .5 * s.height - .111;
		...
		return u.children[0].children[0].children[1].classes.push("svg-align"), W.makeSpan(["mrel", "x-arrow"], [u], t);
	},
	mathmlBuilder(e, t) {
		var n = _r.mathMLnode(e.label);
		n.setAttribute("minsize", e.label.charAt(0) === "x" ? "1.75em" : "3.0em");
		var r;
		if (e.body) {
			var i = Cr(Z(e.body, t));
			if (e.below) {
				var a = Cr(Z(e.below, t));
				r = new X.MathNode("munderover", [
					n,
					a,
					i
				]);
			...
			var o = Cr(Z(e.below, t));
			r = new X.MathNode("munder", [n, o]);
		} else r = Cr(), r = new X.MathNode("mover", [n, r]);
		return r;
	}
});
var wr = W.makeSpan;
function Tr(e, t) {
	var n = J(e.body, t, !0);
	return wr([e.mclass], n, t);
}
function Er(e, t) {
	var n, r = or(e.body, t);
	return e.mclass === "minner" ? n = new X.MathNode("mpadded", r) : e.mclass === "mord" ? e.isCharacterBox ? (n = r[0], n.type = "mi") : n = new X.MathNode("mi", r) : (e.isCharacterBox ? (n = r[0], n.type = "mo") : n = new X.MathNode("mo", r), e.mclass === "mbin" ? (n.attributes.lspace = "0.22em", n.attributes.rspace = "0.22em") : e.mclass === "mpunct" ? (n.attributes.lspace = "0em", n.attributes.rspace = "0.17em") : e.mclass === "mopen" || e.mclass === "mclose" ? (n.attributes.lspace = "0em", n.attributes.rspace = "0em") : e.mclass === "minner" && (n.attributes.lspace = "0.0556em", n.attributes.width = "+0.1111em")), n;
}
K({
	type: "mclass",
	names: [
	...
	handler(e, t) {
		...
		return {
			...
			mclass: "m" + r.slice(5),
			body: q(i),
			isCharacterBox: E.isCharacterBox(i)
		};
	},
	htmlBuilder: Tr,
	mathmlBuilder: Er
...
K({
	...
	handler(e, t) {
		...
		return {
			...
			mclass: Dr(t[0]),
			body: q(t[1]),
			isCharacterBox: E.isCharacterBox(t[1])
		};
	}
}), K({
	type: "mclass",
	...
	props: { numArgs: 2 },
	handler(e, t) {
		var { parser: n, funcName: r } = e, i = t[1], a = t[0], o = r === "\\stackrel" ? "mrel" : Dr(i), s = {
			type: "op",
			mode: i.mode,
			limits: !0,
		...
		return {
			...
			mclass: o,
			body: [c],
			isCharacterBox: E.isCharacterBox(c)
		};
	},
	htmlBuilder: Tr,
	mathmlBuilder: Er
	...
	htmlBuilder(e, t) {
		var n = J(e.body, t, !0), r = W.makeSpan([e.mclass], n, t);
		return r.style.textShadow = "0.02em 0.01em 0.04px", r;
	},
	mathmlBuilder(e, t) {
		var n = or(e.body, t), r = new X.MathNode("mstyle", n);
...
var Or = {
	...
	mode: "math",
	style: "display"
}), Ar = (e) => e.type === "textord" && e.text === "@", jr = (e, t) => (e.type === "mathord" || e.type === "atom") && e.text === t;
function Mr(e, t, n) {
	var r = Or[e];
	switch (r) {
		case "\\\\cdrightarrow":
...
function Nr(e) {
	...
	for (var r = [], i = [r], a = 0; a < t.length; a++) {
		for (var o = t[a], s = kr(), c = 0; c < o.length; c++) if (!Ar(o[c])) s.body.push(o[c]);
		else {
			r.push(s), c += 1;
			var l = vr(o[c]).text, u = [, ,];
			if (u[0] = {
				...
				mode: "math",
				body: []
			}, !("=|.".indexOf(l) > -1)) if ("<>AV".indexOf(l) > -1) for (var d = 0; d < 2; d++) {
				for (var f = !0, p = c + 1; p < o.length; p++) {
					if (jr(o[p], l)) {
						f = !1, c = p;
						break;
					}
					if (Ar(o[p])) throw new T("Missing a " + l + " character to complete a CD arrow.", o[p]);
					u[d].body.push(o[p]);
				}
				if (f) throw new T("Missing a " + l + " character to complete a CD arrow.", o[c]);
			}
...
K({
	...
	htmlBuilder(e, t) {
		var n = t.havingStyle(t.style.sup()), r = W.wrapFragment(Y(e.label, n, t), t);
	...
	mathmlBuilder(e, t) {
		...
		return n = new X.MathNode("mpadded", [n]), n.setAttribute("width", "0"), e.side === "left" && n.setAttribute("lspace", "-1width"), n.setAttribute("voffset", "0.7em"), n = new X.MathNode("mstyle", [n]), n.setAttribute("displaystyle", "false"), n.setAttribute("scriptlevel", "1"), n;
	}
}), K({
	type: "cdlabelparent",
	names: ["\\\\cdparent"],
	...
	handler(e, t) {
		...
		var s = parseInt(i), c;
		if (isNaN(s)) throw new T("\\@char has non-numeric argument " + i);
		if (s < 0 || s >= 1114111) throw new T("\\@char with invalid code point " + i);
...
var Pr = (e, t) => {
	...
	var n = or(e.body, t.withColor(e.color)), r = new X.MathNode("mstyle", n);
...
var Ir = {
	...
	var t = e.text;
	if (/^(?:[\\{}$&#^_]|EOF)$/.test(t)) throw new T("Expected a control sequence", e);
	return t;
}, Rr = (e) => {
...
K({
	...
	handler(e) {
		...
		t.consumeSpaces();
		var r = t.fetch();
		if (Ir[r.text]) return (n === "\\global" || n === "\\\\globallong") && (r.text = Ir[r.text]), Q(t.parseFunction(), "internal");
		throw new T("Invalid token after macro prefix", r);
	}
}), K({
	type: "internal",
	names: [
	...
	handler(e) {
		...
		if (/^(?:[\\{}$&#^_]|EOF)$/.test(i)) throw new T("Expected a control sequence", r);
		for (var a = 0, o, s = [[]]; t.gullet.future().text !== "{";) if (r = t.gullet.popToken(), r.text === "#") {
			if (t.gullet.future().text === "{") {
				o = t.gullet.future(), s[a].push("{");
				break;
			}
			if (r = t.gullet.popToken(), !/^[1-9]$/.test(r.text)) throw new T("Invalid argument number \"" + r.text + "\"");
			if (parseInt(r.text) !== a + 1) throw new T("Argument number \"" + r.text + "\" out of order");
			a++, s.push([]);
		} else {
			if (r.text === "EOF") throw new T("Expected a macro definition");
			s[a].push(r.text);
		}
	...
	handler(e) {
		var { parser: t, funcName: n } = e, r = Lr(t.gullet.popToken());
		return t.gullet.consumeSpaces(), zr(t, r, Rr(t), n === "\\\\globallet"), {
			type: "internal",
			mode: t.mode
		};
	}
	...
	handler(e) {
		var { parser: t, funcName: n } = e, r = Lr(t.gullet.popToken()), i = t.gullet.popToken(), a = t.gullet.popToken();
		return zr(t, r, a, n === "\\\\globalfuture"), t.gullet.pushToken(a), t.gullet.pushToken(i), {
			type: "internal",
			mode: t.mode
		};
	}
...
var Br = function(e, t, n) {
	var r = mt(A.math[e] && A.math[e].replace || e, t, n);
	if (!r) throw Error("Unsupported symbol " + e + " and font size " + t + ".");
	return r;
}, Vr = function(e, t, n, r) {
	var i = n.havingBaseStyle(t), a = W.makeSpan(r.concat(i.sizingClasses(n)), [e], n), o = i.sizeMultiplier / n.sizeMultiplier;
	...
	var o = Vr(W.makeSymbol(e, "Main-Regular", i, r), t, r, a);
	return n && Hr(o, r, t), o;
}, Wr = function(e, t, n, r) {
	return W.makeSymbol(e, "Size" + t + "-Regular", n, r);
}, Gr = function(e, t, n, r, i, a) {
	var o = Wr(e, t, i, r), s = Vr(W.makeSpan(["delimsizing", "size" + t], [o], r), D.TEXT, r, a);
	return n && Hr(s, r, D.TEXT), s;
}, Kr = function(e, t, n) {
	var r = t === "Size1-Regular" ? "delim-size1" : "delim-size4";
	return {
		type: "elem",
		elem: W.makeSpan(["delimsizinginner", r], [W.makeSpan([], [W.makeSymbol(e, t, n)])])
	};
}, qr = function(e, t, n) {
	var r = ut["Size4-Regular"][e.charCodeAt(0)] ? ut["Size4-Regular"][e.charCodeAt(0)][4] : ut["Size1-Regular"][e.charCodeAt(0)][4], i = new Pt([new Ft("inner", ot(e, Math.round(1e3 * t)))], {
		width: k(r),
		height: k(t),
		style: "width:" + k(r),
	...
	return a.height = t, a.style.height = k(t), a.style.width = k(r), {
		type: "elem",
		elem: a
	};
}, Jr = .008, Yr = {
	...
	var te = C / 2 - ee, w = [];
	if (u.length > 0) {
		var ne = C - m - v, re = Math.round(C * 1e3), ie = ct(u, Math.round(ne * 1e3)), ae = new Ft(u, ie), oe = (d / 1e3).toFixed(3) + "em", se = (re / 1e3).toFixed(3) + "em", ce = new Pt([ae], {
			width: oe,
			height: se,
			viewBox: "0 0 " + d + " " + re
		}), le = W.makeSvgSpan([], [ce], r);
		le.height = re / 1e3, le.style.width = oe, le.style.height = se, w.push({
			type: "elem",
			elem: le
		});
	} else {
		if (w.push(Kr(l, f, i)), w.push(Yr), s === null) {
			var ue = C - m - v + 2 * Jr;
			w.push(qr(c, ue, r));
		} else {
			var de = (C - m - v - y) / 2 + 2 * Jr;
			w.push(qr(c, de, r)), w.push(Yr), w.push(Kr(s, f, i)), w.push(Yr), w.push(qr(c, de, r));
		}
		w.push(Yr), w.push(Kr(o, f, i));
	}
	var fe = r.havingBaseStyle(D.TEXT), pe = W.makeVList({
		positionType: "bottom",
		positionData: te,
		children: w
	}, fe);
	return Vr(W.makeSpan(["delimsizing", "mult"], [pe], fe), D.TEXT, r, a);
}, $r = 80, ei = .08, ti = function(e, t, n, r, i) {
	var a = new Pt([new Ft(e, at(e, r, n))], {
		width: "400em",
		height: k(t),
	...
	var n = t.havingBaseSizing(), r = fi("\\surd", e * n.sizeMultiplier, ui, n), i = n.sizeMultiplier, a = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), o, s = 0, c = 0, l = 0, u;
	return r.type === "small" ? (l = 1e3 + 1e3 * a + $r, e < 1 ? i = 1 : e < 1.4 && (i = .7), s = (1 + a + ei) / i, c = (1 + a) / i, o = ti("sqrtMain", s, l, a, t), o.style.minWidth = "0.853em", u = .833 / i) : r.type === "large" ? (l = (1e3 + $r) * oi[r.size], c = (oi[r.size] + a) / i, s = (oi[r.size] + a + ei) / i, o = ti("sqrtSize" + r.size, s, l, a, t), o.style.minWidth = "1.02em", u = 1 / i) : (s = e + a + ei, c = e + a, l = Math.floor(1e3 * e + a) + $r, o = ti("sqrtTall", s, l, a, t), o.style.minWidth = "0.742em", u = 1.056), o.height = c, o.style.height = k(s), {
		span: o,
		advanceWidth: u,
	...
	if (e === "<" || e === "\\lt" || e === "⟨" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"), ri.includes(e) || ai.includes(e)) return Gr(e, t, !1, n, r, i);
	if (ii.includes(e)) return Qr(e, oi[t], !1, n, r, i);
	...
	for (var i = Math.min(2, 3 - r.style.size); i < n.length && n[i].type !== "stack"; i++) {
		var a = Br(e, di(n[i]), "math"), o = a.height + a.depth;
		if (n[i].type === "small") {
	...
	var o = ai.includes(e) ? ci : ri.includes(e) ? ui : li, s = fi(e, t, o, r);
	return s.type === "small" ? Ur(e, s.style, n, r, i, a) : s.type === "large" ? Gr(e, s.size, n, r, i, a) : Qr(e, t, n, r, i, a);
}, mi = {
	sqrtImage: ni,
	sizedDelim: si,
	sizeToMaxHeight: oi,
	...
	leftRightDelim: function(e, t, n, r, i, a) {
		...
		return pi(e, Math.max(l / 500 * s, 2 * l - c), !0, r, i, a);
	}
}, hi = {
	"\\bigl": {
		mclass: "mopen",
...
}, gi = /* @__PURE__ */ "(,\\lparen,),\\rparen,[,\\lbrack,],\\rbrack,\\{,\\lbrace,\\},\\rbrace,\\lfloor,\\rfloor,⌊,⌋,\\lceil,\\rceil,⌈,⌉,<,>,\\langle,⟨,\\rangle,⟩,\\lt,\\gt,\\lvert,\\rvert,\\lVert,\\rVert,\\lgroup,\\rgroup,⟮,⟯,\\lmoustache,\\rmoustache,⎰,⎱,/,\\backslash,|,\\vert,\\|,\\Vert,\\uparrow,\\Uparrow,\\downarrow,\\Downarrow,\\updownarrow,\\Updownarrow,.".split(",");
function _i(e, t) {
	var n = yr(e);
	if (n && gi.includes(n.text)) return n;
	throw n ? new T("Invalid delimiter '" + n.text + "' after '" + t.funcName + "'", e) : new T("Invalid delimiter type '" + e.type + "'", e);
}
K({
	type: "delimsizing",
	names: [
	...
	htmlBuilder: (e, t) => e.delim === "." ? W.makeSpan([e.mclass]) : mi.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]),
	mathmlBuilder: (e) => {
		var t = [];
		e.delim !== "." && t.push(nr(e.delim, e.mode));
		...
		var r = k(mi.sizeToMaxHeight[e.size]);
...
K({
	...
	handler: (e, t) => {
		...
		if (n && typeof n != "string") throw new T("\\current@color set to non-string in \\right");
		return {
			type: "leftright-right",
			mode: e.parser.mode,
			delim: _i(t[0], e).text,
	...
	htmlBuilder: (e, t) => {
		vi(e);
		for (var n = J(e.body, t, !0, ["mopen", "mclose"]), r = 0, i = 0, a = !1, o = 0; o < n.length; o++) n[o].isMiddle ? a = !0 : (r = Math.max(n[o].height, r), i = Math.max(n[o].depth, i));
		r *= t.sizeMultiplier, i *= t.sizeMultiplier;
		var s;
		if (s = e.left === "." ? Xn(t, ["mopen"]) : mi.leftRightDelim(e.left, r, i, t, e.mode, ["mopen"]), n.unshift(s), a) for (var c = 1; c < n.length; c++) {
			var l = n[c].isMiddle;
			l && (n[c] = mi.leftRightDelim(l.delim, r, i, l.options, e.mode, []));
		}
		var u;
		if (e.right === ".") u = Xn(t, ["mclose"]);
		else {
	...
	mathmlBuilder: (e, t) => {
		...
		var n = or(e.body, t);
		if (e.left !== ".") {
			var r = new X.MathNode("mo", [nr(e.left, e.mode)]);
			r.setAttribute("fence", "true"), n.unshift(r);
		}
		if (e.right !== ".") {
			var i = new X.MathNode("mo", [nr(e.right, e.mode)]);
	...
	handler: (e, t) => {
		var n = _i(t[0], e);
		if (!e.parser.leftrightDepth) throw new T("\\middle without preceding \\left", n);
		return {
			type: "middle",
			mode: e.parser.mode,
			delim: n.text
	...
	mathmlBuilder: (e, t) => {
		var n = e.delim === "\\vert" || e.delim === "|" ? nr("|", "text") : nr(e.delim, e.mode), r = new X.MathNode("mo", [n]);
		return r.setAttribute("fence", "true"), r.setAttribute("lspace", "0.05em"), r.setAttribute("rspace", "0.05em"), r;
	}
});
var yi = (e, t) => {
	var n = W.wrapFragment(Y(e.body, t), t), r = e.label.slice(1), i = t.sizeMultiplier, a, o = 0, s = E.isCharacterBox(e.body);
	if (r === "sout") a = W.makeSpan(["stretchy", "sout"]), a.height = t.fontMetrics().defaultRuleThickness / i, o = -.5 * t.fontMetrics().xHeight;
	else if (r === "phase") {
		var c = O({
			number: .6,
			unit: "pt"
		...
		var f = Math.floor(1e3 * d * i), p = new Pt([new Ft("phase", rt(f))], {
			width: "400em",
			height: k(f / 1e3),
			viewBox: "0 0 400000 " + f,
			preserveAspectRatio: "xMinYMin slice"
		});
		a = W.makeSvgSpan(["hide-tail"], [p], t), a.style.height = k(d), o = n.depth + c + l;
	} else {
		/cancel/.test(r) ? s || n.classes.push("cancel-pad") : r === "angl" ? n.classes.push("anglpad") : n.classes.push("boxpad");
		var m = 0, h = 0, g = 0;
		/box/.test(r) ? (g = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness), m = t.fontMetrics().fboxsep + (r === "colorbox" ? 0 : g), h = m) : r === "angl" ? (g = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness), m = 4 * g, h = Math.max(0, .25 - n.depth)) : (m = s ? .2 : 0, h = m), a = _r.encloseSpan(n, r, m, h, t), /fbox|boxed|fcolorbox/.test(r) ? (a.style.borderStyle = "solid", a.style.borderWidth = k(g)) : r === "angl" && g !== .049 && (a.style.borderTopWidth = k(g), a.style.borderRightWidth = k(g)), o = n.depth + h, e.backgroundColor && (a.style.backgroundColor = e.backgroundColor, e.borderColor && (a.style.borderColor = e.borderColor));
	}
	var _;
	if (e.backgroundColor) _ = W.makeVList({
		positionType: "individualShift",
		children: [{
			type: "elem",
			elem: a,
	...
	return /cancel/.test(r) && (_.height = n.height, _.depth = n.depth), /cancel/.test(r) && !s ? W.makeSpan(["mord", "cancel-lap"], [_], t) : W.makeSpan(["mord"], [_], t);
}, bi = (e, t) => {
	var n = 0, r = new X.MathNode(e.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [Z(e.body, t)]);
	switch (e.label) {
		case "\\cancel":
...
function Di(e, t, n) {
	...
	if (e.gullet.beginGroup(), l || e.gullet.macros.set("\\cr", "\\\\\\relax"), !o) {
		...
		if (p == null) o = 1;
		else if (o = parseFloat(p), !o || o < 0) throw new T("Invalid \\arraystretch: " + p);
	}
	e.gullet.beginGroup();
	...
	function b() {
		v && (e.gullet.macros.get("\\df@tag") ? (v.push(e.subparse([new ve("\\df@tag")])), e.gullet.macros.set("\\df@tag", void 0, !0)) : v.push(!!c && e.gullet.macros.get("\\@eqnsw") === "1"));
	}
	for (y(), _.push(wi(e));;) {
		...
		if (S === "&") {
			if (d && m.length === d) {
				if (l || s) throw new T("Too many tab characters: &", e.nextToken);
				e.settings.reportNonstrict("textEnv", "Too few columns specified in the {array} column argument.");
			}
			e.consume();
		} else if (S === "\\end") {
			b(), m.length === 1 && x.type === "styling" && x.body[0].body.length === 0 && (h.length > 1 || !u) && h.pop(), _.length < h.length + 1 && _.push([]);
			break;
		} else if (S === "\\\\") {
			e.consume();
			var C = void 0;
			e.gullet.future().text !== " " && (C = e.parseSizeGroup(!0)), g.push(C ? C.value : null), b(), _.push(wi(e)), m = [], h.push(m), y();
...
var ki = function(e, t) {
	...
	e.colSeparationType && e.colSeparationType === "small" && (d = .2778 * (t.havingStyle(D.SCRIPT).sizeMultiplier / t.sizeMultiplier));
	var f = e.colSeparationType === "CD" ? O({
		number: 3,
		unit: "ex"
	...
	for (v(a[0]), n = 0; n < e.body.length; ++n) {
		...
		for (r = 0; r < y.length; ++r) {
			var C = Y(y[r], t);
			x < C.depth && (x = C.depth), b < C.height && (b = C.height), S[r] = C;
		}
		var ee = e.rowGaps[n], te = 0;
		ee && (te = O(ee, t), te > 0 && (te += g, x < te && (x = te), te = 0)), e.addJot && (x += p), S.height = b, S.depth = x, _ += b, S.pos = _, _ += x + te, s[n] = S, v(a[n + 1]);
	}
	var w = _ / 2 + t.fontMetrics().axisHeight, ne = e.cols || [], re = [], ie, ae, oe = [];
	if (e.tags && e.tags.some((e) => e)) for (n = 0; n < i; ++n) {
		var se = s[n], ce = se.pos - w, le = e.tags[n], ue = void 0;
		ue = le === !0 ? W.makeSpan(["eqn-num"], [], t) : le === !1 ? W.makeSpan([], [], t) : W.makeSpan([], J(le, t, !0), t), ue.depth = se.depth, ue.height = se.height, oe.push({
			type: "elem",
			elem: ue,
			shift: ce
		});
	...
	for (r = 0, ae = 0; r < o || ae < ne.length; ++r, ++ae) {
		for (var de = ne[ae] || {}, fe = !0; de.type === "separator";) {
			if (fe || (ie = W.makeSpan(["arraycolsep"], []), ie.style.width = k(t.fontMetrics().doubleRuleSep), re.push(ie)), de.separator === "|" || de.separator === ":") {
				var pe = de.separator === "|" ? "solid" : "dashed", me = W.makeSpan(["vertical-separator"], [], t);
				me.style.height = k(_), me.style.borderRightWidth = k(l), me.style.borderRightStyle = pe, me.style.margin = "0 " + k(-l / 2);
				var he = _ - w;
				he && (me.style.verticalAlign = k(-he)), re.push(me);
			} else throw new T("Invalid separator type: " + de.separator);
			ae++, de = ne[ae] || {}, fe = !1;
		}
		if (!(r >= o)) {
			var ge = void 0;
			(r > 0 || e.hskipBeforeAndAfter) && (ge = E.deflt(de.pregap, d), ge !== 0 && (ie = W.makeSpan(["arraycolsep"], []), ie.style.width = k(ge), re.push(ie)));
			var _e = [];
			for (n = 0; n < i; ++n) {
				var ve = s[n], ye = ve[r];
				if (ye) {
			...
			_e = W.makeVList({
				positionType: "individualShift",
				children: _e
			}, t), _e = W.makeSpan(["col-align-" + (de.align || "c")], [_e]), re.push(_e), (r < o - 1 || e.hskipBeforeAndAfter) && (ge = E.deflt(de.postgap, d), ge !== 0 && (ie = W.makeSpan(["arraycolsep"], []), ie.style.width = k(ge), re.push(ie)));
		}
	}
	if (s = W.makeSpan(["mtable"], re), c.length > 0) {
		for (var xe = W.makeLineSpan("hline", t, l), Se = W.makeLineSpan("hdashline", t, l), Ce = [{
			type: "elem",
			elem: s,
			shift: 0
		}]; c.length > 0;) {
			var we = c.pop(), Te = we.pos - w;
			we.isDashed ? Ce.push({
				type: "elem",
				elem: Se,
				shift: Te
	...
	if (oe.length === 0) return W.makeSpan(["mord"], [s], t);
	var Ee = W.makeVList({
		positionType: "individualShift",
		children: oe
	}, t);
	return Ee = W.makeSpan(["tag"], [Ee], t), W.makeFragment([s, Ee]);
}, Ai = {
	c: "center ",
	l: "left ",
	r: "right "
}, ji = function(e, t) {
	for (var n = [], r = new X.MathNode("mtd", [], ["mtr-glue"]), i = new X.MathNode("mtd", [], ["mml-eqn-num"]), a = 0; a < e.body.length; a++) {
		for (var o = e.body[a], s = [], c = 0; c < o.length; c++) s.push(new X.MathNode("mtd", [Z(o[c], t)]));
		e.tags && e.tags[a] && (s.unshift(r), s.push(r), e.leqno ? s.unshift(i) : s.push(i)), n.push(new X.MathNode("mtr", s));
	}
	var l = new X.MathNode("mtable", n), u = e.arraystretch === .5 ? .1 : .16 + e.arraystretch - 1 + (e.addJot ? .09 : 0);
	...
	if (e.cols && e.cols.length > 0) {
		...
		for (var v = g; v < _; v++) p[v].type === "align" ? (f += Ai[p[v].align], h && (m += "none "), h = !0) : p[v].type === "separator" && h && (m += p[v].separator === "|" ? "solid " : "dashed ", h = !1);
		l.setAttribute("columnalign", f.trim()), /[sd]/.test(m) && l.setAttribute("columnlines", m.trim());
	}
	if (e.colSeparationType === "align") {
		for (var y = e.cols || [], b = "", x = 1; x < y.length; x++) b += x % 2 ? "0em " : "1em ";
	...
	var S = "", C = e.hLinesBeforeRow;
	d += C[0].length > 0 ? "left " : "", d += C[C.length - 1].length > 0 ? "right " : "";
	for (var ee = 1; ee < C.length - 1; ee++) S += C[ee].length === 0 ? "none " : C[ee][0] ? "dashed " : "solid ";
	return /[sd]/.test(S) && l.setAttribute("rowlines", S.trim()), d !== "" && (l = new X.MathNode("menclose", [l]), l.setAttribute("notation", d.trim())), e.arraystretch && e.arraystretch < 1 && (l = new X.MathNode("mstyle", [l]), l.setAttribute("scriptlevel", "1")), l;
}, Mi = function(e, t) {
	e.envName.indexOf("ed") === -1 && Ti(e);
	var n = [], r = e.envName.indexOf("at") > -1 ? "alignat" : "align", i = e.envName === "split", a = Di(e.parser, {
		cols: n,
		addJot: !0,
		autoTag: i ? void 0 : Ei(e.envName),
		emptySingleRow: !0,
		colSeparationType: r,
...
Si({
	...
	props: { numArgs: 1 },
	handler(e, t) {
		var n = (yr(t[0]) ? [t[0]] : Q(t[0], "ordgroup").body).map(function(e) {
			var t = vr(e).text;
			...
			throw new T("Unknown column alignment: " + t, e);
		}), r = {
			cols: n,
			hskipBeforeAndAfter: !0,
			maxNumCols: n.length
		};
		return Di(e.parser, r, Oi(e.envName));
	},
	htmlBuilder: ki,
	mathmlBuilder: ji
}), Si({
	...
	handler(e) {
		...
		if (e.envName.charAt(e.envName.length - 1) === "*") {
			...
			if (i.consumeSpaces(), i.fetch().text === "[") {
				if (i.consume(), i.consumeSpaces(), n = i.fetch().text, "lcr".indexOf(n) === -1) throw new T("Expected l or c or r", i.nextToken);
		...
		var a = Di(e.parser, r, Oi(e.envName)), o = Math.max(0, ...a.body.map((e) => e.length));
	...
	props: { numArgs: 0 },
	handler(e) {
		var t = Di(e.parser, { arraystretch: .5 }, "script");
	...
	handler(e, t) {
		...
		if (r = Di(e.parser, r, "script"), r.body.length > 0 && r.body[0].length > 1) throw new T("{subarray} can contain only one column");
		return r;
	},
	htmlBuilder: ki,
	mathmlBuilder: ji
	...
	props: { numArgs: 0 },
	handler(e) {
		["gather", "gather*"].includes(e.envName) && Ti(e);
		var t = {
			cols: [{
				type: "align",
				align: "c"
			...
			autoTag: Ei(e.envName),
			emptySingleRow: !0,
			leqno: e.parser.settings.leqno
		};
		return Di(e.parser, t, "display");
	},
	htmlBuilder: ki,
	mathmlBuilder: ji
}), Si({
...
K({
	...
	handler(e, t) {
		var { parser: n, funcName: r } = e, i = t[0];
		if (i.type !== "ordgroup") throw new T("Invalid environment name", i);
		for (var a = "", o = 0; o < i.body.length; ++o) a += Q(i.body[o], "textord").text;
		if (r === "\\begin") {
			if (!Ni.hasOwnProperty(a)) throw new T("No such environment: " + a, i);
			var s = Ni[a], { args: c, optArgs: l } = n.parseArguments("\\begin{" + a + "}", s), u = {
				mode: n.mode,
				envName: a,
				parser: n
			}, d = s.handler(u, c, l);
			...
			if (p.name !== a) throw new T("Mismatch: \\begin{" + a + "} matched by \\end{" + p.name + "}", f);
			return d;
		}
		return {
			type: "environment",
...
K({
	...
	handler: (e, t) => {
		var { parser: n, funcName: r } = e, i = Bn(t[0]), a = r;
		return a in Ii && (a = Ii[a]), {
			type: "font",
			mode: n.mode,
			font: a.slice(1),
			body: i
	...
	props: { numArgs: 1 },
	handler: (e, t) => {
		var { parser: n } = e, r = t[0], i = E.isCharacterBox(r);
		return {
			type: "mclass",
			mode: n.mode,
			mclass: Dr(r),
...
var Li = (e, t) => {
	var n = t;
	return e === "display" ? n = n.id >= D.SCRIPT.id ? n.text() : D.DISPLAY : e === "text" && n.size === D.DISPLAY.size ? n = D.TEXT : e === "script" ? n = D.SCRIPT : e === "scriptscript" && (n = D.SCRIPTSCRIPT), n;
}, Ri = (e, t) => {
	var n = Li(e.size, t.style), r = n.fracNum(), i = n.fracDen(), a = t.havingStyle(r), o = Y(e.numer, a, t);
	if (e.continued) {
	...
	e.hasBarLine ? (e.barSize ? (d = O(e.barSize, t), u = W.makeLineSpan("frac-line", t, d)) : u = W.makeLineSpan("frac-line", t), d = u.height, f = u.height) : (u = null, d = 0, f = t.fontMetrics().defaultRuleThickness);
	var p, m, h;
	n.size === D.DISPLAY.size || e.size === "display" ? (p = t.fontMetrics().num1, m = d > 0 ? 3 * f : 7 * f, h = t.fontMetrics().denom1) : (d > 0 ? (p = t.fontMetrics().num2, m = f) : (p = t.fontMetrics().num3, m = 3 * f), h = t.fontMetrics().denom2);
	var g;
	if (u) {
		...
		y < m && (p += .5 * (m - y), h += .5 * (m - y)), g = W.makeVList({
			positionType: "individualShift",
			children: [{
				type: "elem",
				elem: l,
	...
	var b = n.size === D.DISPLAY.size ? t.fontMetrics().delim1 : n.size === D.SCRIPTSCRIPT.size ? t.havingStyle(D.SCRIPT).fontMetrics().delim2 : t.fontMetrics().delim2, x, S;
	return x = e.leftDelim == null ? Xn(t, ["mopen"]) : mi.customSizedDelim(e.leftDelim, b, !0, t.havingStyle(n), e.mode, ["mopen"]), S = e.continued ? W.makeSpan([]) : e.rightDelim == null ? Xn(t, ["mclose"]) : mi.customSizedDelim(e.rightDelim, b, !0, t.havingStyle(n), e.mode, ["mclose"]), W.makeSpan(["mord"].concat(a.sizingClasses(t)), [
		x,
		W.makeSpan(["mfrac"], [g]),
		S
	], t);
	...
	if (e.leftDelim != null || e.rightDelim != null) {
		...
		if (o.push(n), e.rightDelim != null) {
			var c = new X.MathNode("mo", [new X.TextNode(e.rightDelim.replace("\\", ""))]);
...
K({
	...
	handler: (e, t) => {
		var { parser: n, funcName: r } = e, i = t[0], a = t[1], o, s = null, c = null, l = "auto";
		switch (r) {
			case "\\dfrac":
			case "\\frac":
			case "\\tfrac":
	...
	props: { numArgs: 2 },
	handler: (e, t) => {
		var { parser: n, funcName: r } = e, i = t[0], a = t[1];
		return {
			type: "genfrac",
			mode: n.mode,
			continued: !0,
...
K({
	...
	handler(e, t) {
		var { parser: n } = e, r = t[4], i = t[5], a = Bn(t[0]), o = a.type === "atom" && a.family === "open" ? Vi(a.text) : null, s = Bn(t[1]), c = s.type === "atom" && s.family === "close" ? Vi(s.text) : null, l = Q(t[2], "size"), u, d = null;
	...
	handler: (e, t) => {
		var { parser: n, funcName: r } = e, i = t[0], a = De(Q(t[1], "infix").size), o = t[2], s = a.number > 0;
		return {
			type: "genfrac",
			mode: n.mode,
			numer: i,
...
var Hi = (e, t) => {
	...
	var a = Y(i.base, t.havingBaseStyle(D.DISPLAY)), o = _r.svgSpan(i, t), s;
	if (i.isOver ? (s = W.makeVList({
		positionType: "firstBaseline",
		children: [
			{
				type: "elem",
	...
	}, t), s.children[0].children[0].children[1].classes.push("svg-align")) : (s = W.makeVList({
		positionType: "bottom",
...
K({
	...
	mathmlBuilder: (e, t) => {
		var n = sr(e.body, t);
		return n instanceof er || (n = new er("mrow", [n])), n.setAttribute("href", e.href), n;
	}
}), K({
	type: "href",
	names: ["\\url"],
	...
	mathmlBuilder(e, t) {
		return new X.MathNode("mrow", or(e.body, t));
	}
}), K({
	type: "html",
	names: [
		...
		switch (r) {
			...
			case "\\htmlData":
				for (var l = a.split(","), u = 0; u < l.length; u++) {
					var d = l[u].split("=");
					if (d.length !== 2) throw new T("Error parsing key-value for \\htmlData");
	...
	htmlBuilder: (e, t) => {
		var n = J(e.body, t, !1), r = ["enclosing"];
...
var Ui = function(e) {
	...
	if (!Ct(n)) throw new T("Invalid unit: '" + n.unit + "' in \\includegraphics.");
	return n;
};
K({
	...
	handler: (e, t, n) => {
		...
		if (n[0]) for (var c = Q(n[0], "raw").string, l = c.split(","), u = 0; u < l.length; u++) {
			var d = l[u].split("=");
			if (d.length === 2) {
				var f = d[1].trim();
				switch (d[0].trim()) {
					...
					case "totalheight":
						o = Ui(f);
						break;
					default: throw new T("Invalid key: '" + d[0] + "' in \\includegraphics.");
				}
			}
		}
		var p = Q(t[0], "url").url;
	...
	htmlBuilder: (e, t) => {
		var n;
		e.alignment === "clap" ? (n = W.makeSpan([], [Y(e.body, t)]), n = W.makeSpan(["inner"], [n], t)) : n = W.makeSpan(["inner"], [Y(e.body, t)]);
		var r = W.makeSpan(["fix"], []), i = W.makeSpan([e.alignment], [n, r], t), a = W.makeSpan(["strut"]);
		return a.style.height = k(i.height + i.depth), i.depth && (a.style.verticalAlign = k(-i.depth)), i.children.unshift(a), i = W.makeSpan(["thinbox"], [i], t), W.makeSpan(["mord", "vbox"], [i], t);
	},
	mathmlBuilder: (e, t) => {
...
K({
	...
	mathmlBuilder: (e, t) => sr(Wi(e, t), t)
});
var Gi = (e, t, n, r, i, a, o) => {
	e = W.makeSpan([], [e]);
	var s = n && E.isCharacterBox(n), c, l;
	if (t) {
	...
	var f;
	if (l && c) {
		var p = r.fontMetrics().bigOpSpacing5 + c.elem.height + c.elem.depth + c.kern + e.depth + o;
		f = W.makeVList({
			positionType: "bottom",
			positionData: p,
			children: [
	...
	var g = [f];
	if (c && a !== 0 && !s) {
		var _ = W.makeSpan(["mspace"], [], r);
		_.style.marginRight = k(a), g.unshift(_);
	}
	return W.makeSpan(["mop", "op-limits"], g, r);
}, Ki = ["\\smallint"], qi = (e, t) => {
	var n, r, i = !1, a;
	e.type === "supsub" ? (n = e.sup, r = e.sub, a = Q(e.base, "op"), i = !0) : a = Q(e, "op");
	var o = t.style, s = !1;
	o.size === D.DISPLAY.size && a.symbol && !Ki.includes(a.name) && (s = !0);
	var c;
	if (a.symbol) {
		var l = s ? "Size2-Regular" : "Size1-Regular", u = "";
		if ((a.name === "\\oiint" || a.name === "\\oiiint") && (u = a.name.slice(1), a.name = u === "oiint" ? "\\iint" : "\\iiint"), c = W.makeSymbol(a.name, l, "math", t, [
			"mop",
			"op-symbol",
			s ? "large-op" : "small-op"
		]), u.length > 0) {
			var d = c.italic, f = W.staticSvg(u + "Size" + (s ? "2" : "1"), t);
			c = W.makeVList({
				positionType: "individualShift",
				children: [{
					type: "elem",
			...
			}, t), a.name = "\\" + u, c.classes.unshift("mop"), c.italic = d;
		}
	} else if (a.body) {
		var p = J(a.body, t, !0);
		p.length === 1 && p[0] instanceof Nt ? (c = p[0], c.classes[0] = "mop") : c = W.makeSpan(["mop"], p, t);
	} else {
		for (var m = [], h = 1; h < a.name.length; h++) m.push(W.mathsym(a.name[h], a.mode, t));
		c = W.makeSpan(["mop"], m, t);
	}
	var g = 0, _ = 0;
	return (c instanceof Nt || a.name === "\\oiint" || a.name === "\\oiiint") && !a.suppressBaseShift && (g = (c.height - c.depth) / 2 - t.fontMetrics().axisHeight, _ = c.italic), i ? Gi(c, n, r, t, o, _, g) : (g && (c.style.position = "relative", c.style.top = k(g)), c);
}, Ji = (e, t) => {
	var n;
	if (e.symbol) n = new er("mo", [nr(e.name, e.mode)]), Ki.includes(e.name) && n.setAttribute("largeop", "false");
	else if (e.body) n = new er("mo", or(e.body, t));
	else {
		n = new er("mi", [new tr(e.name.slice(1))]);
		var r = new er("mo", [nr("⁡", "text")]);
		n = e.parentIsSupSub ? new er("mrow", [n, r]) : $n([n, r]);
	}
	return n;
}, Yi = {
	"∏": "\\prod",
...
var Zi = (e, t) => {
	...
	if (a.body.length > 0) {
		for (var s = J(a.body.map((e) => {
			...
			var l = s[c];
			l instanceof Nt && (l.text = l.text.replace(/\u2212/, "-").replace(/\u2217/, "*"));
		}
		o = W.makeSpan(["mop"], s, t);
	} else o = W.makeSpan(["mop"], [], t);
	return i ? Gi(o, n, r, t, t.style, 0, 0) : o;
};
K({
	type: "operatorname",
	...
	htmlBuilder: Zi,
	mathmlBuilder: (e, t) => {
		for (var n = or(e.body, t.withFont("mathrm")), r = !0, i = 0; i < n.length; i++) {
			var a = n[i];
			if (!(a instanceof X.SpaceNode)) if (a instanceof X.MathNode) switch (a.type) {
				case "mi":
				case "mn":
				case "ms":
				case "mspace":
				...
				case "mo":
					var o = a.children[0];
					a.children.length === 1 && o instanceof X.TextNode ? o.text = o.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : r = !1;
					break;
				default: r = !1;
			}
			else r = !1;
		...
		var l = new X.MathNode("mo", [nr("⁡", "text")]);
		return e.parentIsSupSub ? new X.MathNode("mrow", [c, l]) : X.newDocumentFragment([c, l]);
	}
}), $("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@"), zn({
	type: "ordgroup",
	htmlBuilder(e, t) {
		return e.semisimple ? W.makeFragment(J(e.body, t, !1)) : W.makeSpan(["mord"], J(e.body, t, !0), t);
	},
	mathmlBuilder(e, t) {
	...
	htmlBuilder(e, t) {
		var n = Y(e.body, t.havingCrampedStyle()), r = W.makeLineSpan("overline-line", t), i = t.fontMetrics().defaultRuleThickness, a = W.makeVList({
			positionType: "firstBaseline",
			children: [
				{
					type: "elem",
	...
	htmlBuilder: (e, t) => {
		...
		return n = W.makeVList({
			positionType: "firstBaseline",
			children: [{
				type: "elem",
				elem: n
			}]
		}, t), W.makeSpan(["mord"], [n], t);
	},
	mathmlBuilder: (e, t) => {
		var n = or(q(e.body), t), r = new X.MathNode("mphantom", n), i = new X.MathNode("mpadded", [r]);
	...
	htmlBuilder: (e, t) => {
		var n = W.makeSpan(["inner"], [Y(e.body, t.withPhantom())]), r = W.makeSpan(["fix"], []);
	...
	mathmlBuilder(e, t) {
		var n = new X.MathNode("mpadded", [Z(e.body, t)]), r = e.dy.number + e.dy.unit;
	...
	htmlBuilder(e, t) {
		var n = W.makeSpan(["mord", "rule"], [], t), r = O(e.width, t), i = O(e.height, t), a = e.shift ? O(e.shift, t) : 0;
	...
	mathmlBuilder(e, t) {
		var n = O(e.width, t), r = O(e.height, t), i = e.shift ? O(e.shift, t) : 0, a = t.color && t.getColor() || "black", o = new X.MathNode("mspace");
...
function Qi(e, t, n) {
	for (var r = J(e, t, !1), i = t.sizeMultiplier / n.sizeMultiplier, a = 0; a < r.length; a++) {
...
K({
	...
	mathmlBuilder: (e, t) => {
		var n = t.havingSize(e.size), r = or(e.body, n), i = new X.MathNode("mstyle", r);
	...
	handler: (e, t, n) => {
		...
		if (o) for (var s = "", c = 0; c < o.body.length; ++c) if (s = o.body[c].text, s === "t") i = !0;
		else if (s === "b") a = !0;
		else {
			i = !1, a = !1;
			break;
	...
	htmlBuilder(e, t) {
		...
		n.height === 0 && (n.height = t.fontMetrics().xHeight), n = W.wrapFragment(n, t);
		var r = t.fontMetrics().defaultRuleThickness, i = r;
		t.style.id < D.TEXT.id && (i = t.fontMetrics().xHeight);
		var a = r + i / 4, o = n.height + n.depth + a + r, { span: s, ruleWidth: c, advanceWidth: l } = mi.sqrtImage(o, t), u = s.height - c;
		...
		if (e.index) {
			var p = t.havingStyle(D.SCRIPTSCRIPT), m = Y(e.index, p, t), h = .6 * (f.height - f.depth), g = W.makeVList({
				positionType: "shift",
				positionData: -h,
				children: [{
					type: "elem",
			...
			}, t), _ = W.makeSpan(["root"], [g]);
			return W.makeSpan(["mord", "sqrt"], [_, f], t);
		} else return W.makeSpan(["mord", "sqrt"], [f], t);
	},
	mathmlBuilder(e, t) {
		var { body: n, index: r } = e;
		return r ? new X.MathNode("mroot", [Z(n, t), Z(r, t)]) : new X.MathNode("msqrt", [Z(n, t)]);
	}
});
var ea = {
	display: D.DISPLAY,
...
K({
	...
	htmlBuilder(e, t) {
		var n = ea[e.style], r = t.havingStyle(n).withFont("");
		return Qi(e.body, r, t);
	},
	mathmlBuilder(e, t) {
		var n = ea[e.style], r = t.havingStyle(n), i = or(e.body, r), a = new X.MathNode("mstyle", i), o = {
			display: ["0", "true"],
			text: ["0", "false"],
			script: ["1", "false"],
...
var ta = function(e, t) {
	var n = e.base;
	return n ? n.type === "op" ? n.limits && (t.style.size === D.DISPLAY.size || n.alwaysHandleSupSub) ? qi : null : n.type === "operatorname" ? n.alwaysHandleSupSub && (t.style.size === D.DISPLAY.size || n.limits) ? Zi : null : n.type === "accent" ? E.isCharacterBox(n.base) ? br : null : n.type === "horizBrace" && !e.sub === n.isOver ? Hi : null : null;
};
zn({
	type: "supsub",
	htmlBuilder(e, t) {
		var n = ta(e, t);
		if (n) return n(e, t);
		var { base: r, sup: i, sub: a } = e, o = Y(r, t), s, c, l = t.fontMetrics(), u = 0, d = 0, f = r && E.isCharacterBox(r);
		if (i) {
			var p = t.havingStyle(t.style.sup());
			s = Y(i, p, t), f || (u = o.height - p.fontMetrics().supDrop * p.sizeMultiplier / t.sizeMultiplier);
		}
		if (a) {
			var m = t.havingStyle(t.style.sub());
			c = Y(a, m, t), f || (d = o.depth + m.fontMetrics().subDrop * m.sizeMultiplier / t.sizeMultiplier);
		}
		var h = t.style === D.DISPLAY ? l.sup1 : t.style.cramped ? l.sup3 : l.sup2, g = t.sizeMultiplier, _ = k(.5 / l.ptPerEm / g), v = null;
		if (c) {
			var y = e.base && e.base.type === "op" && e.base.name && (e.base.name === "\\oiint" || e.base.name === "\\oiiint");
			(o instanceof Nt || y) && (v = k(-o.italic));
		}
		var b;
		if (s && c) {
			...
			d = Math.max(d, l.sub1, c.height - .8 * l.xHeight);
			var ee = [{
				type: "elem",
				elem: c,
				marginLeft: v,
		...
		} else if (s) u = Math.max(u, h, s.depth + .25 * l.xHeight), b = W.makeVList({
			positionType: "shift",
			positionData: -u,
			children: [{
				type: "elem",
		...
		var te = Yn(o, "right") || "mord";
		return W.makeSpan([te], [o, W.makeSpan(["msupsub"], [b])], t);
	},
	mathmlBuilder(e, t) {
		var n = !1, r, i;
		...
		if (n) o = r ? "mover" : "munder";
			...
			var s = e.base;
			o = s && s.type === "op" && s.limits && t.style === D.DISPLAY || s && s.type === "operatorname" && s.alwaysHandleSupSub && (t.style === D.DISPLAY || s.limits) ? "munderover" : "msubsup";
		} else {
			var c = e.base;
			o = c && c.type === "op" && c.limits && (t.style === D.DISPLAY || c.alwaysHandleSupSub) || c && c.type === "operatorname" && c.alwaysHandleSupSub && (c.limits || t.style === D.DISPLAY) ? "munder" : "msub";
		}
		else {
			var l = e.base;
			o = l && l.type === "op" && l.limits && (t.style === D.DISPLAY || l.alwaysHandleSupSub) || l && l.type === "operatorname" && l.alwaysHandleSupSub && (l.limits || t.style === D.DISPLAY) ? "mover" : "msup";
		}
	...
	mathmlBuilder(e, t) {
		var n = new X.MathNode("mo", [nr(e.text, e.mode)]);
		if (e.family === "bin") {
			var r = ir(e, t);
...
zn({
	...
	mathmlBuilder(e, t) {
		var n = new X.MathNode("mi", [nr(e.text, e.mode, t)]), r = ir(e, t) || "italic";
		return r !== na[n.type] && n.setAttribute("mathvariant", r), n;
	}
}), zn({
	type: "textord",
	htmlBuilder(e, t) {
	...
	mathmlBuilder(e, t) {
		var n = nr(e.text, e.mode, t), r = ir(e, t) || "normal", i;
		return i = e.mode === "text" ? new X.MathNode("mtext", [n]) : /[0-9]/.test(e.text) ? new X.MathNode("mn", [n]) : e.text === "\\prime" ? new X.MathNode("mo", [n]) : new X.MathNode("mi", [n]), r !== na[i.type] && i.setAttribute("mathvariant", r), i;
	}
});
var ra = {
	"\\nobreak": "nobreak",
...
zn({
	type: "spacing",
	htmlBuilder(e, t) {
		if (ia.hasOwnProperty(e.text)) {
			var n = ia[e.text].className || "";
			if (e.mode === "text") {
				var r = W.makeOrd(e, t, "textord");
				return r.classes.push(n), r;
			} else return W.makeSpan(["mspace", n], [W.mathsym(e.text, e.mode, t)], t);
		} else {
			if (ra.hasOwnProperty(e.text)) return W.makeSpan(["mspace", ra[e.text]], [], t);
			throw new T("Unknown type of space \"" + e.text + "\"");
		}
	},
	mathmlBuilder(e, t) {
		var n;
		if (ia.hasOwnProperty(e.text)) n = new X.MathNode("mtext", [new X.TextNode("\xA0")]);
		else {
			if (ra.hasOwnProperty(e.text)) return new X.MathNode("mspace");
			throw new T("Unknown type of space \"" + e.text + "\"");
		}
		return n;
	}
...
zn({
	type: "tag",
	mathmlBuilder(e, t) {
		var n = new X.MathNode("mtable", [new X.MathNode("mtr", [
			aa(),
			new X.MathNode("mtd", [sr(e.body, t)]),
			aa(),
			new X.MathNode("mtd", [sr(e.tag, t)])
		])]);
...
var oa = {
	...
	var n = e.font;
	if (n) {
		if (oa[n]) return t.withTextFontFamily(oa[n]);
		if (sa[n]) return t.withTextFontWeight(sa[n]);
...
K({
	...
	htmlBuilder(e, t) {
		var n = Y(e.body, t), r = W.makeLineSpan("underline-line", t), i = t.fontMetrics().defaultRuleThickness, a = W.makeVList({
			positionType: "top",
			positionData: n.height,
			children: [
				{
	...
	htmlBuilder(e, t) {
		var n = Y(e.body, t), r = t.fontMetrics().axisHeight, i = .5 * (n.height - r - (n.depth + r));
		return W.makeVList({
			positionType: "shift",
			positionData: i,
			children: [{
	...
	htmlBuilder(e, t) {
		for (var n = ua(e), r = [], i = t.havingStyle(t.style.text()), a = 0; a < n.length; a++) {
			var o = n[a];
			o === "~" && (o = "\\textasciitilde"), r.push(W.makeSymbol(o, "Typewriter-Regular", e.mode, i, ["mord", "texttt"]));
		}
		return W.makeSpan(["mord", "text"].concat(i.sizingClasses(t)), W.tryCombineChars(r), i);
	},
	mathmlBuilder(e, t) {
		var n = new X.TextNode(ua(e)), r = new X.MathNode("mtext", [n]);
		return r.setAttribute("mathvariant", "monospace"), r;
	}
});
var ua = (e) => e.body.replace(/ /g, e.star ? "␣" : "\xA0"), da = In, fa = "[ \r\n	]", pa = "\\\\[a-zA-Z@]+", ma = "\\\\[^\ud800-\udfff]", ha = "(" + pa + ")" + fa + "*", ga = "\\\\(\n|[ \r	]+\n?)[ \r	]*", _a = "[̀-ͯ]", va = RegExp(_a + "+$"), ya = "(" + fa + "+)|" + (ga + "|") + "([!-\\[\\]-‧‪-퟿豈-￿]" + (_a + "*") + "|[\ud800-\udbff][\udc00-\udfff]" + (_a + "*") + "|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5" + ("|" + ha) + ("|" + ma + ")"), ba = class {
	constructor(e, t) {
		this.input = void 0, this.settings = void 0, this.tokenRegex = void 0, this.catcodes = void 0, this.input = e, this.settings = t, this.tokenRegex = new RegExp(ya, "g"), this.catcodes = {
			"%": 14,
			"~": 13
		};
	}
	...
	lex() {
		...
		if (t === e.length) return new ve("EOF", new _e(this, t, t));
		var n = this.tokenRegex.exec(e);
		if (n === null || n.index !== t) throw new T("Unexpected character: '" + e[t] + "'", new ve(e[t], new _e(this, t, t + 1)));
		var r = n[6] || n[3] || (n[2] ? "\\ " : " ");
		...
		return new ve(r, new _e(this, t, this.tokenRegex.lastIndex));
	}
}, xa = class {
	constructor(e, t) {
...
$("\\char", function(e) {
	...
	if (t.text === "'") n = 8, t = e.popToken();
		...
		if (t.text === "EOF") throw new T("\\char` missing argument");
		r = t.text.charCodeAt(0);
	}
	else n = 10;
	if (n) {
		if (r = Ca[t.text], r == null || r >= n) throw new T("Invalid base-" + n + " digit " + t.text);
		for (var i; (i = Ca[e.future().text]) != null && i < n;) r *= n, r += i, e.popToken();
	}
	return "\\@char{" + r + "}";
});
var wa = (e, t, n, r) => {
	var i = e.consumeArg().tokens;
	if (i.length !== 1) throw new T("\\newcommand's first argument must be a macro name");
	var a = i[0].text, o = e.isDefined(a);
	if (o && !t) throw new T("\\newcommand{" + a + "} attempting to redefine " + (a + "; use \\renewcommand"));
	if (!o && !n) throw new T("\\renewcommand{" + a + "} when command " + a + " does not yet exist; use \\newcommand");
	var s = 0;
	if (i = e.consumeArg().tokens, i.length === 1 && i[0].text === "[") {
		for (var c = "", l = e.expandNextToken(); l.text !== "]" && l.text !== "EOF";) c += l.text, l = e.expandNextToken();
		if (!c.match(/^\s*[0-9]+\s*$/)) throw new T("Invalid number of arguments: " + c);
...
$("\\newcommand", (e) => wa(e, !1, !0, !1)), $("\\renewcommand", (e) => wa(e, !0, !1, !1)), $("\\providecommand", (e) => wa(e, !0, !0, !0)), $("\\message", (e) => {
	...
	return console.log(t, e.macros.get(n), da[n], A.math[n], A.text[n]), "";
...
$("\\dots", function(e) {
	...
	return n in Ta ? t = Ta[n] : (n.slice(0, 4) === "\\not" || n in A.math && ["bin", "rel"].includes(A.math[n].group)) && (t = "\\dotsb"), t;
});
var Ea = {
	")": !0,
	"]": !0,
...
$("\\dotso", function(e) {
	return e.future().text in Ea ? "\\ldots\\," : "\\ldots";
}), $("\\dotsc", function(e) {
	var t = e.future().text;
	return t in Ea && t !== "," ? "\\ldots\\," : "\\ldots";
}), $("\\cdots", function(e) {
	return e.future().text in Ea ? "\\@cdots\\," : "\\@cdots";
...
var ka = {
	...
	constructor(e, t, n) {
		this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new xa(Sa, t.macros), this.mode = n, this.stack = [];
	}
	feed(e) {
	...
	scanArgument(e) {
		...
		return this.pushToken(new ve("EOF", n.loc)), this.pushTokens(r), new ve("", _e.range(t, n));
	}
	consumeSpaces() {
	...
	consumeArg(e) {
		...
		do {
			if (i = this.popToken(), t.push(i), i.text === "{") ++a;
				...
				if (--a, a === -1) throw new T("Extra }", i);
			} else if (i.text === "EOF") throw new T("Unexpected end of input in a macro argument, expected '" + (e && n ? e[o] : "}") + "'", i);
	...
	consumeArgs(e, t) {
		if (t) {
			...
			for (var n = t[0], r = 0; r < n.length; r++) {
				var i = this.popToken();
				if (n[r] !== i.text) throw new T("Use of the macro doesn't match its definition", i);
			}
		}
	...
	expandOnce(e) {
		...
		if (r == null || e && r.unexpandable) {
			if (e && r == null && n[0] === "\\" && !this.isDefined(n)) throw new T("Undefined control sequence: " + n);
		...
		if (r.numArgs) {
			...
			for (var o = i.length - 1; o >= 0; --o) {
				var s = i[o];
				if (s.text === "#") {
					if (o === 0) throw new T("Incomplete placeholder at end of macro body", s);
					if (s = i[--o], s.text === "#") i.splice(o + 1, 1);
					else if (/^[1-9]$/.test(s.text)) i.splice(o, 2, ...a[s.text - 1]);
					else throw new T("Not a valid argument number", s);
				}
			}
		}
	...
	_getExpansion(e) {
		...
		if (typeof r == "string") {
			var i = 0;
			if (r.indexOf("#") !== -1) for (var a = r.replace(/##/g, ""); a.indexOf("#" + (i + 1)) !== -1;) ++i;
			for (var o = new ba(r, this.settings), s = [], c = o.lex(); c.text !== "EOF";) s.push(c), c = o.lex();
			return s.reverse(), {
				tokens: s,
				numArgs: i
			};
	...
	isDefined(e) {
		return this.macros.has(e) || da.hasOwnProperty(e) || A.math.hasOwnProperty(e) || A.text.hasOwnProperty(e) || ka.hasOwnProperty(e);
	}
	isExpandable(e) {
		var t = this.macros.get(e);
		return t == null ? da.hasOwnProperty(e) && !da[e].primitive : typeof t == "string" || typeof t == "function" || !t.unexpandable;
	}
}, ja = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, Ma = Object.freeze({
	"₊": "+",
	"₋": "-",
	"₌": "=",
	"₍": "(",
	...
	constructor(e, t) {
		this.mode = void 0, this.gullet = void 0, this.settings = void 0, this.leftrightDepth = void 0, this.nextToken = void 0, this.mode = "math", this.gullet = new Aa(e, t, this.mode), this.settings = t, this.leftrightDepth = 0;
	}
	expect(e, t) {
		if (t === void 0 && (t = !0), this.fetch().text !== e) throw new T("Expected '" + e + "', got '" + this.fetch().text + "'", this.fetch());
		t && this.consume();
	}
	consume() {
		this.nextToken = null;
	...
	parseExpression(t, n) {
		for (var r = [];;) {
			...
			var i = this.fetch();
			if (e.endOfExpression.indexOf(i.text) !== -1 || n && i.text === n || t && da[i.text] && da[i.text].infix) break;
	...
	handleInfixNodes(e) {
		for (var t = -1, n, r = 0; r < e.length; r++) if (e[r].type === "infix") {
			if (t !== -1) throw new T("only one infix operator per group", e[r].token);
			t = r, n = e[r].replaceWith;
		}
		if (t !== -1 && n) {
			var i, a, o = e.slice(0, t), s = e.slice(t + 1);
			i = o.length === 1 && o[0].type === "ordgroup" ? o[0] : {
				type: "ordgroup",
				mode: this.mode,
				body: o
			}, a = s.length === 1 && s[0].type === "ordgroup" ? s[0] : {
				type: "ordgroup",
				mode: this.mode,
				body: s
			};
			var c;
			return c = n === "\\\\abovefrac" ? this.callFunction(n, [
				i,
				e[t],
				a
			], []) : this.callFunction(n, [i, a], []), [c];
		} else return e;
	}
	handleSupSubscript(e) {
		...
		if (!r) throw new T("Expected group after '" + n + "'", t);
		return r;
	}
	...
	parseAtom(e) {
		...
		for (var n, r;;) {
			...
			if (i.text === "\\limits" || i.text === "\\nolimits") {
				...
				if (n) throw new T("Double superscript", i);
				n = this.handleSupSubscript("superscript");
			} else if (i.text === "_") {
				if (r) throw new T("Double subscript", i);
				...
				var s = ja.test(i.text), c = [];
				for (c.push(new ve(Ma[i.text])), this.consume();;) {
					var l = this.fetch().text;
					if (!Ma[l] || ja.test(l) !== s) break;
					c.unshift(new ve(Ma[l])), this.consume();
				}
	...
	parseFunction(e, t) {
		var n = this.fetch(), r = n.text, i = da[r];
		if (!i) return null;
		if (this.consume(), t && t !== "atom" && !i.allowedInArgument) throw new T("Got function '" + r + "' with no arguments" + (t ? " as " + t : ""), n);
		if (this.mode === "text" && !i.allowedInText) throw new T("Can't use function '" + r + "' in text mode", n);
		if (this.mode === "math" && i.allowedInMath === !1) throw new T("Can't use function '" + r + "' in math mode", n);
	...
	parseArguments(e, t) {
		...
		for (var r = [], i = [], a = 0; a < n; a++) {
			...
			(t.primitive && o == null || t.type === "sqrt" && a === 1 && i[0] == null) && (o = "primitive");
	...
	parseGroupOfType(e, t, n) {
		switch (t) {
			...
			case "primitive":
				if (n) throw new T("A primitive argument cannot be optional");
				var a = this.parseGroup(e);
				if (a == null) throw new T("Expected group as " + e, this.fetch());
				return a;
			case "original":
			case null:
			case void 0: return this.parseArgumentGroup(n);
			default: throw new T("Unknown group type as " + e, this.fetch());
		}
	}
	consumeSpaces() {
	...
	parseRegexGroup(e, t) {
		...
		if (i === "") throw new T("Invalid " + t + ": '" + n.text + "'", n);
		return n.range(r, i);
	}
	parseColorGroup(e) {
		...
		if (!n) throw new T("Invalid color: '" + t.text + "'", t);
		var r = n[0];
	...
	parseSizeGroup(e) {
		...
		if (!r) throw new T("Invalid size: '" + t.text + "'", t);
		var i = {
			number: +(r[1] + r[2]),
			unit: r[3]
		};
		if (!Ct(i)) throw new T("Invalid unit: '" + i.unit + "'", t);
		return {
			type: "size",
			mode: this.mode,
			value: i,
	...
	parseGroup(e, t) {
		...
		} else if (i = this.parseFunction(t, e) || this.parseSymbol(), i == null && r[0] === "\\" && !ka.hasOwnProperty(r)) {
			if (this.settings.throwOnError) throw new T("Undefined control sequence: " + r, n);
	...
	formLigatures(e) {
		for (var t = e.length - 1, n = 0; n < t; ++n) {
			...
			i === "-" && e[n + 1].text === "-" && (n + 1 < t && e[n + 2].text === "-" ? (e.splice(n, 3, {
				type: "textord",
				mode: "text",
				loc: _e.range(r, e[n + 2]),
				text: "---"
			}), t -= 2) : (e.splice(n, 2, {
				type: "textord",
				mode: "text",
				loc: _e.range(r, e[n + 1]),
				text: "--"
	...
	parseSymbol() {
		...
		if (/^\\verb[^a-zA-Z]/.test(t)) {
			...
			if (r && (n = n.slice(1)), n.length < 2 || n.charAt(0) !== n.slice(-1)) throw new T("\\verb assertion failed --\n                    please report what input caused this bug");
		...
		Pa.hasOwnProperty(t[0]) && !A[this.mode][t[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", "Accented Unicode text character \"" + t[0] + "\" used in math mode", e), t = Pa[t[0]] + t.slice(1));
		var i = va.exec(t);
		i && (t = t.substring(0, i.index), t === "i" ? t = "ı" : t === "j" && (t = "ȷ"));
		var a;
		if (A[this.mode][t]) {
			this.settings.strict && this.mode === "math" && on.indexOf(t) >= 0 && this.settings.reportNonstrict("unicodeTextInMathMode", "Latin-1/Unicode text character \"" + t[0] + "\" used in math mode", e);
			var o = A[this.mode][t].group, s = _e.range(e), c;
			...
			a = c;
		} else if (t.charCodeAt(0) >= 128) this.settings.strict && (Xe(t.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", "Unicode text character \"" + t[0] + "\" used in math mode", e) : this.settings.reportNonstrict("unknownSymbol", "Unrecognized Unicode character \"" + t[0] + "\"" + (" (" + t.charCodeAt(0) + ")"), e)), a = {
			type: "textord",
			mode: "text",
			loc: _e.range(e),
			text: t
		...
		if (this.consume(), i) for (var u = 0; u < i[0].length; u++) {
			var d = i[0][u];
			if (!Na[d]) throw new T("Unknown accent ' " + d + "'", e);
			var f = Na[d][this.mode] || Na[d].text;
			if (!f) throw new T("Accent " + d + " unsupported in " + this.mode + " mode", e);
			a = {
				type: "accent",
				mode: this.mode,
				loc: _e.range(e),
...
typeof document < "u" && document.compatMode !== "CSS1Compat" && (typeof console < "u" && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), La = function() {
	throw new T("KaTeX doesn't work in quirks mode.");
});
var Ra = function(e, t) {
	return Va(e, t).toMarkup();
}, za = function(e, t) {
	return Ia(e, new Ae(t));
}, Ba = function(e, t, n) {
	if (n.throwOnError || !(e instanceof T)) throw e;
	var r = W.makeSpan(["katex-error"], [new Nt(t)]);
	return r.setAttribute("title", e.toString()), r.setAttribute("style", "color:" + n.errorColor), r;
}, Va = function(e, t) {
	var n = new Ae(t);
	try {
		return dr(Ia(e, n), e, n);
	} catch (t) {
		return Ba(t, e, n);
	}
}, Ha = {
...
function Ga(t) {
	let r = t || Ua;
	return function(t, i) {
		e(t, "element", function(e, t) {
			let a = Array.isArray(e.properties.className) ? e.properties.className : Wa, o = a.includes("language-math"), s = a.includes("math-display"), c = a.includes("math-inline"), l = s;
			if (!o && !s && !c) return;
			let u = t[t.length - 1], d = e;
			if (e.tagName === "code" && o && u && u.type === "element" && u.tagName === "pre" && (d = u, u = t[t.length - 2], l = !0), !u) return;
			let f = se(d, { whitespace: "pre" }), p;
			try {
				p = Ha.renderToString(f, {
					...r,
					displayMode: l,
					throwOnError: !0
				});
			} catch (n) {
				let a = n, o = a.name.toLowerCase();
			...
			typeof p == "string" && (p = h(p).children);
...
//# sourceMappingURL=index-Dk9oWC2N-BsV_n44Y.js.map