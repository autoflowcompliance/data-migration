import { IHostConfigProperties } from '@streamlit/utils';
...
declare interface CodeCompletionRequestPayload {
    code: string;
    line: number;
    column: number;
}

declare type DetailedMountOptions = SimplifiedStliteKernelOptions & Partial<ToastOptions> & Partial<StyleOptions>;
...
declare type FSType = typeof FS & PyodideFSType;
...
declare type InMessage = InMessageInitData | InMessageReboot | InMessageWebSocketConnect | InMessageWebSocketSend | InMessageHttpRequest | InMessageFileWrite | InMessageFileRename | InMessageFileUnlink | InMessageFileRead | InMessageInstall | InMessageSetEnv | InMessageCodeCompletion | InMessageAddMockPackage | InMessageRunPython;

declare interface InMessageAddMockPackage extends InMessageBase {
 ...
 */
declare interface InMessageBase {
    type: string;
    data?: unknown;
}

declare interface InMessageCodeCompletion extends InMessageBase {
    type: "code_completion";
    data: CodeCompletionRequestPayload;
}

declare interface InMessageFileRead extends InMessageBase {
    type: "file:read";
    data: {
        path: string;
...
declare interface InMessageFileRename extends InMessageBase {
    type: "file:rename";
    data: {
        oldPath: string;
        newPath: string;
...
declare interface InMessageFileUnlink extends InMessageBase {
    type: "file:unlink";
    data: {
        path: string;
    };
...
declare interface InMessageFileWrite extends InMessageBase {
    type: "file:write";
    data: {
        path: string;
        data: string | ArrayBufferView;
...
declare interface InMessageHttpRequest extends InMessageBase {
    type: "http:request";
    data: {
        request: HttpRequest;
    };
...
declare interface InMessageInitData extends InMessageBase {
    type: "initData";
    data: WorkerInitialData;
}

declare interface InMessageInstall extends InMessageBase {
    type: "install";
    data: {
        requirements: string[];
...
declare interface InMessageReboot extends InMessageBase {
    type: "reboot";
    data: {
        entrypoint: string;
    };
...
declare interface InMessageRunPython extends InMessageBase {
    type: "run_python";
    data: {
        code: string;
    };
...
declare interface InMessageSetEnv extends InMessageBase {
    type: "setEnv";
    data: {
...
declare interface InMessageWebSocketConnect extends InMessageBase {
...
declare interface InMessageWebSocketSend extends InMessageBase {
    type: "websocket:send";
    data: {
        payload: Uint8Array;
    };
...
export declare function mount(options: MountOptions, container?: HTMLElement): {
    unmount: () => void;
    install: (requirements: string[], options?: MicropipInstallOptions) => Promise<void>;
    addMockPackage: (name: string, version: string, modules?: Record<string, string>, persistent?: boolean) => Promise<void>;
    writeFile: (path: string, data: string | ArrayBufferView, opts?: Record<string, unknown>) => Promise<void>;
    renameFile: (oldPath: string, newPath: string) => Promise<void>;
    unlink: (path: string) => Promise<void>;
    readFile: (path: string, opts?: Record<string, unknown>) => Promise<string | Uint8Array<ArrayBufferLike>>;
...
declare interface PyodideFSType {
    	filesystems: any;
...
declare class StliteKernel extends EventTarget {
    /**
     * Made public for advanced use cases as an unstable API.
     * You can use it but there is no stability guarantee for future releases.
     */
    readonly _worker: StliteWorker | SharedWorker;
    private _isDisposed;
    private _postMessageTarget;
    private _loaded;
    private _workerInitData;
    readonly basePath: string;
    readonly hostConfigProperties: IHostConfigProperties;
    addEventListener<K extends keyof StliteKernelEventMap>(type: K, listener: StliteKernelEventListenerOrEventListenerObject<K>, options?: boolean | AddEventListenerOptions): void;
    removeEventListener<K extends keyof StliteKernelEventMap>(type: K, listener: StliteKernelEventListenerOrEventListenerObject<K>, options?: boolean | EventListenerOptions): void;
    dispatchEvent(event: StliteKernelEventMap[keyof StliteKernelEventMap]): boolean;
    constructor(options: StliteKernelOptions);
    get loaded(): Promise<void>;
    connectWebSocket(path: string): Promise<void>;
    sendWebSocketMessage(payload: Uint8Array): Promise<void>;
    private handleWebSocketMessage;
    onWebSocketMessage(handler: (payload: ArrayBuffer | string) => void): void;
    sendHttpRequest(request: HttpRequest, signal?: AbortSignal): Promise<HttpResponse>;
    writeFile(path: string, data: string | ArrayBufferView, opts?: Record<string, unknown>): Promise<void>;
    renameFile(oldPath: string, newPath: string): Promise<void>;
    readFile(path: string, opts?: Record<string, unknown>): Promise<string | Uint8Array>;
    unlink(path: string): Promise<void>;
    install(requirements: string[], options?: MicropipInstallOptions): Promise<void>;
    addMockPackage(name: string, version: string, modules?: Record<string, string>, persistent?: boolean): Promise<void>;
     ...
     */
    reboot(entrypoint: string): Promise<void>;
...
declare type StliteKernelEventHandlerObject<K extends keyof StliteKernelEventMap> = {
    handleEvent(object: StliteKernelEventMap[K]): void;
};

declare type StliteKernelEventListener<K extends keyof StliteKernelEventMap> = (ev: StliteKernelEventMap[K]) => void;

declare type StliteKernelEventListenerOrEventListenerObject<K extends keyof StliteKernelEventMap> = StliteKernelEventListener<K> | StliteKernelEventHandlerObject<K>;

declare interface StliteKernelEventMap {
...
declare interface StliteWorker extends Worker {
