...
function q({ instance: e, providedFormat: t, state: n = I, decimalSeparator: r, defaults: i = n.currentDefaults() }) {
	...
	let C = me(a.toString(), a, m, p, h, x);
	return C = he(C, a, l, c), C = _e(C, a, g, n, r), (f || b) && (C = ve(C, S)), (y || a < 0) && (C = ye(C, a, v)), C;
}
function J(e, t) {
	if (!e) return t;
	let n = Object.keys(e);
	return n.length === 1 && n[0] === "output" ? t : e;
}
var Se = (e) => ({
	format: (...t) => ee(...t, e),
	getByteUnit: (...t) => ie(...t, e),
	getBinaryByteUnit: (...t) => re(...t, e),
	getDecimalByteUnit: (...t) => ne(...t, e),
	formatOrDefault: J
}), Y = F;
function Ce(e, t, n) {
	let r = new Y(e._value), i = t;
	return n.isNumbro(t) && (i = t._value), i = new Y(i), e._value = r.plus(i).toNumber(), e;
}
function we(e, t, n) {
	let r = new Y(e._value), i = t;
	return n.isNumbro(t) && (i = t._value), i = new Y(i), e._value = r.minus(i).toNumber(), e;
}
function Te(e, t, n) {
	let r = new Y(e._value), i = t;
	return n.isNumbro(t) && (i = t._value), i = new Y(i), e._value = r.times(i).toNumber(), e;
}
function Ee(e, t, n) {
	let r = new Y(e._value), i = t;
	return n.isNumbro(t) && (i = t._value), i = new Y(i), e._value = r.dividedBy(i).toNumber(), e;
}
function De(e, t, n) {
	let r = t;
...
function Oe(e, t, n) {
	let r = n(e._value);
	return we(r, t, n), Math.abs(r._value);
}
var ke = (e) => ({
	add: (t, n) => Ce(t, n, e),
	subtract: (t, n) => we(t, n, e),
	multiply: (t, n) => Te(t, n, e),
	divide: (t, n) => Ee(t, n, e),
	set: (t, n) => De(t, n, e),
	difference: (t, n) => Oe(t, n, e),
	BigNumber: Y
}), Ae = "2.5.0", X = A(), je = u(), Me = N($), Ne = s(), Z = Se($), Q = ke($), Pe = D, Fe = class {
	constructor(e) {
		this._value = e;
	}
	clone() {
	...
	format(e = {}) {
		return Z.format(this, e);
	}
	formatCurrency(e) {
		return typeof e == "string" && (e = Pe.parseFormat(e)), e = Z.formatOrDefault(e, X.currentCurrencyDefaultFormat()), e.output = "currency", Z.format(this, e);
	}
	formatTime(e = {}) {
		return e.output = "time", Z.format(this, e);
	}
	binaryByteUnits() {
		return Z.getBinaryByteUnit(this);
	}
	decimalByteUnits() {
		return Z.getDecimalByteUnit(this);
	}
	byteUnits() {
		return Z.getByteUnit(this);
	}
	difference(e) {
		return Q.difference(this, e);
	}
	add(e) {
		return Q.add(this, e);
	}
	subtract(e) {
		return Q.subtract(this, e);
	}
	multiply(e) {
		return Q.multiply(this, e);
	}
	divide(e) {
		return Q.divide(this, e);
	}
	set(e) {
		return Q.set(this, Ie(e));
	}
	value() {
		return this._value;
	}
...
function Ie(e) {
	let t = e;
	return $.isNumbro(e) ? t = e._value : typeof e == "string" ? t = $.unformat(e) : isNaN(e) && (t = NaN), t;
}
function $(e) {
	return new Fe(Ie(e));
}
$.version = Ae, $.isNumbro = function(e) {
	return e instanceof Fe;
}, $.language = X.currentLanguage, $.registerLanguage = X.registerLanguage, $.setLanguage = X.setLanguage, $.languages = X.languages, $.languageData = X.languageData, $.zeroFormat = X.setZeroFormat, $.defaultFormat = X.currentDefaults, $.setDefaults = X.setDefaults, $.defaultCurrencyFormat = X.currentCurrencyDefaultFormat, $.validate = je.validate, $.loadLanguagesInNode = Me.loadLanguagesInNode, $.unformat = Ne.unformat, $.BigNumber = Q.BigNumber;
var Le = /* @__PURE__ */ t($);
//#endregion
export { Le as t };

//# sourceMappingURL=numbro-CDdPhOTG-MkRfyTGH.js.map